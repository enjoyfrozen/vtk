...
const double vtkParallelCoordinatesRepresentation::Internals::Colors[10][3] = { { 1.0, 0.0,
                                                                                  0.0 }, // red
  { 0.0, 1.0, 0.0 },                                                                     // green
  { 0.0, .8, 1.0 },                                                                      // cyan
  { .8, .8, 0.0 },                                                                       // yellow
...
void vtkParallelCoordinatesRepresentation::UpdateHoverHighlight(vtkView* view, int x, int y)
{
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::RequestData(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* vtkNotUsed(outputVector))
{
  ...
  vtkIdTypeArray* unselectedRows = nullptr;
  if (this->InverseSelection->GetNode(0))
    unselectedRows =
      vtkArrayDownCast<vtkIdTypeArray>(this->InverseSelection->GetNode(0)->GetSelectionList());
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::FillInputPortInformation(int port, vtkInformation* info)
{
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::AllocatePolyData(vtkPolyData* polyData, int numLines,
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::PlaceLines(
  vtkPolyData* polyData, vtkTable* data, vtkIdTypeArray* idsToPlot)
{
  if (!polyData)
    return 0;
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::PlaceCurves(
  vtkPolyData* polyData, vtkTable* data, vtkIdTypeArray* idsToPlot)
{
  if (!polyData)
    return 0;
...
//------------------------------------------------------------------------------
void vtkParallelCoordinatesRepresentation::BuildDefaultSCurve(
  vtkDoubleArray* defArray, int numValues)
{
  if (!defArray)
    return;
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::PlaceSelection(
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::SwapAxisPositions(int position1, int position2)
{
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::SetXCoordinateOfPosition(int position, double xcoord)
{
...
//------------------------------------------------------------------------------
void vtkParallelCoordinatesRepresentation::LassoSelect(
  int brushClass, int brushOperator, vtkPoints* brushPoints)
{
  ...
  vtkSmartPointer<vtkBivariateLinearTableThreshold> threshold =
    nullptr; // vtkSmartPointer<vtkBivariateLinearTableThreshold>::New();
...
//------------------------------------------------------------------------------
void vtkParallelCoordinatesRepresentation::LassoSelectInternal(
  vtkPoints* brushPoints, vtkIdTypeArray* outIds)
{
...
void vtkParallelCoordinatesRepresentation::AngleSelect(
...
void vtkParallelCoordinatesRepresentation::FunctionSelect(
...
void vtkParallelCoordinatesRepresentation::RangeSelect(int vtkNotUsed(brushClass),
  int vtkNotUsed(brushOperator), double* vtkNotUsed(p1), double* vtkNotUsed(p2))
{
  // stubbed out for now
}
...
//------------------------------------------------------------------------------
int vtkParallelCoordinatesRepresentation::ComputeLinePosition(double* p1, double* p2)
{
  double eps = .0001;
...
//------------------------------------------------------------------------------
vtkSelection* vtkParallelCoordinatesRepresentation::ConvertSelection(
...
void vtkParallelCoordinatesRepresentation::SelectRows(
  vtkIdType brushClass, vtkIdType brushOperator, vtkIdTypeArray* newSelectedIds)
{
  ...
  while (!node)
  {
    ...
    newnode->GetProperties()->Set(vtkSelectionNode::CONTENT_TYPE(), vtkSelectionNode::PEDIGREEIDS);
    newnode->GetProperties()->Set(vtkSelectionNode::FIELD_TYPE(), vtkSelectionNode::ROW);
...
void vtkParallelCoordinatesRepresentation::BuildInverseSelection()
{
  ...
  for (int i = 0; i < this->NumberOfSamples; i++)
  {
    ...
    for (int j = 0; j < numNodes; j++)
    {
      ...
      vtkIdTypeArray* a =
        vtkArrayDownCast<vtkIdTypeArray>(selection->GetNode(j)->GetSelectionList());
...
int vtkParallelCoordinatesRepresentation::GetRangeAtPosition(int position, double range[2])
{
  if (position < 0 || position >= this->NumberOfAxes)
  {
    return -1;
...
int vtkParallelCoordinatesRepresentation::SetRangeAtPosition(int position, double range[2])
{
  if (position < 0 || position >= this->NumberOfAxes)
  {
    return -1;
...
int vtkParallelCoordinatesRepresentation::GetPositionAndSize(double* position, double* size)
{
  if (!this->Xs)
    return 0;
...
int vtkParallelCoordinatesRepresentation::SetPositionAndSize(double* position, double* size)
{
...
//------------------------------------------------------------------------------
vtkPolyDataMapper2D* vtkParallelCoordinatesRepresentation::InitializePlotMapper(
  vtkPolyData* input, vtkActor2D* actor, bool vtkNotUsed(forceStandard))
{
