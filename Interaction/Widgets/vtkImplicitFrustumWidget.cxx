...
vtkImplicitFrustumWidget::vtkImplicitFrustumWidget()
{
  ...
  this->CallbackMapper->SetCallbackMethod(vtkCommand::RightButtonPressEvent, vtkWidgetEvent::Scale,
    this, vtkImplicitFrustumWidget::ScaleAction);
  this->CallbackMapper->SetCallbackMethod(vtkCommand::RightButtonReleaseEvent,
    vtkWidgetEvent::EndScale, this, vtkImplicitFrustumWidget::EndSelectAction);

  // Mouse motion: Move the frustum around
  this->CallbackMapper->SetCallbackMethod(
    vtkCommand::MouseMoveEvent, vtkWidgetEvent::Move, this, vtkImplicitFrustumWidget::MoveAction);

  // Arrow keys: Move the frustum around
  this->CallbackMapper->SetCallbackMethod(vtkCommand::KeyPressEvent, vtkEvent::AnyModifier, 30, 1,
    "Up", vtkWidgetEvent::Up, this, vtkImplicitFrustumWidget::MoveFrustumAction);
  this->CallbackMapper->SetCallbackMethod(vtkCommand::KeyPressEvent, vtkEvent::AnyModifier, 28, 1,
    "Right", vtkWidgetEvent::Up, this, vtkImplicitFrustumWidget::MoveFrustumAction);
  this->CallbackMapper->SetCallbackMethod(vtkCommand::KeyPressEvent, vtkEvent::AnyModifier, 31, 1,
    "Down", vtkWidgetEvent::Down, this, vtkImplicitFrustumWidget::MoveFrustumAction);
  this->CallbackMapper->SetCallbackMethod(vtkCommand::KeyPressEvent, vtkEvent::AnyModifier, 29, 1,
    "Left", vtkWidgetEvent::Down, this, vtkImplicitFrustumWidget::MoveFrustumAction);
...
void vtkImplicitFrustumWidget::SelectAction(vtkAbstractWidget* w)
{
  ...
  if (repr->GetInteractionState() == vtkImplicitFrustumRepresentation::Outside)
  {
    return;
  }

  if (self->Interactor->GetControlKey() &&
    interactionState == vtkImplicitFrustumRepresentation::MovingOrigin)
  {
    repr->SetInteractionState(vtkImplicitFrustumRepresentation::TranslatingOrigin);
  }
  ...
  self->WidgetState = vtkImplicitFrustumWidget::Active;
...
void vtkImplicitFrustumWidget::TranslateAction(vtkAbstractWidget* w)
{
  ...
  repr->SetInteractionState(vtkImplicitFrustumRepresentation::Moving);
  int interactionState = repr->ComputeInteractionState(X, Y);
  self->UpdateCursorShape(interactionState);
...
//------------------------------------------------------------------------------
void vtkImplicitFrustumWidget::ScaleAction(vtkAbstractWidget* w)
{
  vtkImplicitFrustumWidget* self = reinterpret_cast<vtkImplicitFrustumWidget*>(w);
  vtkImplicitFrustumRepresentation* repr = self->GetFrustumRepresentation();
  ...
  repr->SetInteractionState(vtkImplicitFrustumRepresentation::Scaling);
  int interactionState = repr->ComputeInteractionState(X, Y);
  self->UpdateCursorShape(interactionState);
...
void vtkImplicitFrustumWidget::MoveAction(vtkAbstractWidget* w)
{
  ...
  if (self->ManagesCursor && self->WidgetState != vtkImplicitFrustumWidget::Active)
  {
    auto oldState = static_cast<vtkImplicitFrustumRepresentation::InteractionStateType>(
      representation->GetInteractionState());

    representation->SetInteractionState(vtkImplicitFrustumRepresentation::Moving);
  ...
  if (self->WidgetState == vtkImplicitFrustumWidget::Idle)
  {
...
void vtkImplicitFrustumWidget::EndSelectAction(vtkAbstractWidget* w)
{
  ...
  if (self->WidgetState != vtkImplicitFrustumWidget::Active ||
    repr->GetInteractionState() == vtkImplicitFrustumRepresentation::Outside)
  {
    return;
  }
  ...
  self->WidgetState = vtkImplicitFrustumWidget::Idle;
  self->ReleaseFocus();
...
void vtkImplicitFrustumWidget::MoveFrustumAction(vtkAbstractWidget* w)
{
  ...
  // Invoke all of the events associated with moving the frustum
  self->InvokeEvent(vtkCommand::StartInteractionEvent, nullptr);
