...
SetSymmetricTensor(double symTensor[6])
{
  double tensor[9];
...
//----------------------------------------------------------------------------
void vtkTensorRepresentation::
MovePlusXFace(const double* p1, const double* p2, bool entry)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkTensorRepresentation::
MoveMinusXFace(const double* p1, const double* p2, bool entry)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkTensorRepresentation::
MovePlusYFace(const double* p1, const double* p2, bool entry)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkTensorRepresentation::
MoveMinusYFace(const double* p1, const double* p2, bool entry)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkTensorRepresentation::
MovePlusZFace(const double* p1, const double* p2, bool entry)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
...
//----------------------------------------------------------------------------
void vtkTensorRepresentation::
MoveMinusZFace(const double* p1, const double* p2, bool entry)
{
  double* pts = static_cast<vtkDoubleArray*>(this->Points->GetData())->GetPointer(0);
