...
//------------------------------------------------------------------------------
void vtkImplicitPlaneRepresentation::SetSelectedWidgetColor(
...
//------------------------------------------------------------------------------
void vtkImplicitPlaneRepresentation::SetUnselectedWidgetColor(
  double r, double g, double b)
{
...
//------------------------------------------------------------------------------
void vtkImplicitPlaneRepresentation::SetForegroundWidgetColor(
  double r, double g, double b)
{
