 ...
 * vtkImplicitPlaneRepresentation for usage information.
 *
 * @sa
...
class VTKINTERACTIONWIDGETS_EXPORT vtkImplicitImageRepresentation : public vtkImplicitPlaneRepresentation
{
public:
  /**
   ...
   */
  void PlaceWidget(vtkImageData* img);
  void PlaceWidget(vtkAlgorithmOutput* aout);
  //@}
