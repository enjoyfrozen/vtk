...
int TestDistanceWidget(int vtkNotUsed(argc), char* vtkNotUsed(argv)[])
{
  ...
  {
    std::cerr << "Error setting ruler distance to 0.25, get returned " << rep->GetRulerDistance()
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (p1w)
  {
    std::cout << "Point 1 World Position: " << p1w[0] << ", " << p1w[1] << ", " << p1w[2]
              << std::endl;
  }
  else
  {
  ...
  if (p2w)
  {
    std::cout << "Point 2 World Position: " << p2w[0] << ", " << p2w[1] << ", " << p2w[2]
              << std::endl;
  }
  else
  {
  ...
  {
    std::cerr << "Error: distance between the world positions of the end points = " << pointDistance
              << ", while the representation's distance is " << distance << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (fabs(pointDistance - distance) > 0.01)
  {
    std::cerr << "Error: distance between the new world positions of the end points = "
              << pointDistance << ", while the representation's distance is " << distance
              << std::endl;
    return EXIT_FAILURE;
  }
  ...
  std::cout << "Point 1 Display Position: " << p1d[0] << ", " << p1d[1] << ", " << p1d[2]
            << std::endl;
  double p2d[3];
  rep->GetPoint2DisplayPosition(p2d);
  std::cout << "Point 2 Display Position: " << p2d[0] << ", " << p2d[1] << ", " << p2d[2]
            << std::endl;
