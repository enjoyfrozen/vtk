...
class TestTensorWidget2(vtk.test.Testing.vtkTest):
    ...
    def testTensorWidget(self):
        ...
        # tensor and associated glyph. This test places an initial tensor
        ...
        img_file = "TestTensorWidget2.png"
        vtk.test.Testing.compareImage(iRen.GetRenderWindow(), vtk.test.Testing.getAbsImagePath(img_file), threshold=25)
        vtk.test.Testing.interact()

if __name__ == "__main__":
     vtk.test.Testing.main([(TestTensorWidget2, 'test')])
