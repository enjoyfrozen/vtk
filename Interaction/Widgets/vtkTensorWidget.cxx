...
vtkTensorWidget::vtkTensorWidget()
{
...

  {
    ...
    ed->SetDevice(vtkEventDataDevice::RightController);
    this->CallbackMapper->SetCallbackMethod(
      vtkCommand::Move3DEvent, ed.Get(), vtkWidgetEvent::Move3D, this, vtkTensorWidget::MoveAction3D);
  }
...
void vtkTensorWidget::SelectAction(vtkAbstractWidget* w)
{
  ...
  reinterpret_cast<vtkTensorRepresentation*>(self->WidgetRep)->SetInteractionState(interactionState);
