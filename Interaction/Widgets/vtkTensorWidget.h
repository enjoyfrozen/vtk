 ...
 * it handles the events that drive its corresponding representation). The
 * widget is assumed to operate on a single 3x3 tensor located at a specified
 * position. The tensor implicitly defines three orthogonal eigenvectors
 * which indicate the orientation and relative scaling of the widget's
 * representation.
 *
