...
constexpr double SPHERE_THETA_RES = 16;
constexpr double SPHERE_PHI_RES = 16;
}
...
vtkSmartPointer<vtkActor> vtk3DCursorRepresentation::vtkInternals::CreateSphereCursor()
{
  ...
  sphere->SetThetaResolution(SPHERE_THETA_RES);
  sphere->SetPhiResolution(SPHERE_PHI_RES);
