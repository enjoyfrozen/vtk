...
//------------------------------------------------------------------------------
int TestTrackballZoom(int argc, char* argv[])
{
  std::ostringstream strm;
  strm << "TestTrackballZoom: Setup" << endl;
  ...
  strm << "TestTrackballZoom: Window" << endl;
  ...
  else
  {
    ...
    recorder->SetInputString(TestRecordEventLog_PartialRightZoom);
