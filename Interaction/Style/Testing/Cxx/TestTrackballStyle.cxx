...
//------------------------------------------------------------------------------
int TestTrackballStyle(int argc, char* argv[])
{
  std::ostringstream strm;
  strm << "TestTrackballStyle Setup" << endl;
  ...
  strm << "TestTrackballStyle: Window" << endl;
  ...
  strm << "TestTrackballStyle: Recorder" << endl;
  ...
  strm << "TestTrackballStyle: Verification" << endl;
