/*=========================================================================
  ...
  Module:    TestTrackballConstrainedStyle.cxx
...
//------------------------------------------------------------------------------
int TestTrackballConstrainedStyle(int argc, char* argv[])
{
  std::ostringstream strm;
  strm << "TestTrackballConstrainedStyle Setup" << endl;
  ...
  strm << "TestTrackballConstrainedStyle: Window" << endl;
  ...
  trackball->SetRotationModel(vtkTrackballRotationModel::WorldZ_ScreenX);
