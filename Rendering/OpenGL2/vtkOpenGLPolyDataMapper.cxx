  ...
  vtkPolyData* poly, std::vector<unsigned int> (&indices)[4], vtkIdType offset)
{
  ...
  vtkOpenGLPolyDataMapper::AppendPointIndexBuffer(indices[0], this->SelectionArrays[0], offset);

  if (fieldType == vtkSelectionNode::SelectionField::POINT)
  {
    vtkOpenGLPolyDataMapper::AppendPointIndexBuffer(indices[1], this->SelectionArrays[1], offset);
    vtkOpenGLPolyDataMapper::ppendPointIndexBuffer(indices[2], this->SelectionArrays[2], offset);
    vtkOpenGLPolyDataMapper::AppendPointIndexBuffer(indices[3], this->SelectionArrays[3], offset);
    this->SelectionType = VTK_POINTS;
  }
  else
  {
