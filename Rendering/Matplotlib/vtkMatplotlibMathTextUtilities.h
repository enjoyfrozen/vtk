...
private:
   ...
   */
  bool RenderOneCell(vtkImageData* image, int bbox[4], std::int64_t rowStart,
    std::int64_t colStart, vtkSmartPyObject& pythonData, std::uint64_t pythonRows,
    std::uint64_t pythonCols, std::uint64_t cellRows, std::uint64_t cellCols,
