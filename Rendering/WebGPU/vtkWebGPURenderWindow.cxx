...
vtkCxxSetObjectMacro(vtkWebGPURenderWindow, WebGPUInstance, vtkWebGPUInstance);
...
bool vtkWebGPURenderWindow::WGPUInit()
{
  ...
  // device. wgpu::RequestAdapterOptions options; options.powerPreference = this->PowerPreference;
...
void vtkWebGPURenderWindow::CreateFSQGraphicsPipeline()
{
  ...
  //  vtkWebGPUInternalsBindGroupLayout::MakeBindGroupLayout(this->Device,
  //    {
  //      // clang-format off
  //    { 0, wgpu::ShaderStage::Fragment, wgpu::TextureSampleType::Float,
  //    wgpu::TextureViewDimension::e2D, /*multiSampled=*/false }
  //      // clang-format on
  //    });
  ...
  //    });
  //
  //  wgpu::ShaderModule shaderModule = vtkWebGPUInternalsShaderModule::CreateFromWGSL(this->Device,
  //  R"(
  //    struct VertexOutput {
...
//------------------------------------------------------------------------------
// void vtkWebGPURenderWindow::FlushCommandBuffers(vtkTypeUInt32 count, wgpu::CommandBuffer*
// buffers)
// {
...
//   this->ReadPixels();
//
//   PixelReadDescriptor desc = ::GetPixelReadDesriptor(this->ColorAttachment.Texture, x, y, x2,
//   y2); unsigned char* pixels = new unsigned char[desc.Rect.GetWidth() * desc.Rect.GetHeight() *
//   3];
////  int componentMap[3] = {};
////
...
//{
//   PixelReadDescriptor desc = ::GetPixelReadDesriptor(this->ColorAttachment.Texture, x, y, x2,
//   y2); data->SetNumberOfComponents(3); data->SetNumberOfTuples(desc.Rect.GetWidth() *
//   desc.Rect.GetHeight()); unsigned char* pixels = this->GetPixelData(x, y, x2, y2, front, right);
...
//
//   PixelReadDescriptor desc = ::GetPixelReadDesriptor(this->ColorAttachment.Texture, x, y, x2,
//   y2); float* pixels = new float[desc.Rect.GetWidth() * desc.Rect.GetHeight() * 4]; int
//   componentMap[4] = {};
//
//   if (this->ColorAttachment.Format == wgpu::TextureFormat::BGRA8Unorm)
//   {
...
//{
//   PixelReadDescriptor desc = ::GetPixelReadDesriptor(this->ColorAttachment.Texture, x, y, x2,
//   y2); data->SetNumberOfComponents(4); data->SetNumberOfTuples(desc.Rect.GetWidth() *
//   desc.Rect.GetHeight()); float* pixels = this->GetRGBAPixelData(x, y, x2, y2, front, right);
//   // take ownership of pixels
...
////------------------------------------------------------------------------------
// int vtkWebGPURenderWindow::SetRGBAPixelData(
//   int x, int y, int x2, int y2, vtkFloatArray* data, int front, int blend /*=0*/, int right
//   /*=0*/)
//{
...
//   PixelReadDescriptor desc = ::GetPixelReadDesriptor(this->ColorAttachment.Texture, x, y, x2,
//   y2); data->SetNumberOfComponents(4); data->SetNumberOfTuples(desc.Rect.GetWidth() *
//   desc.Rect.GetHeight()); unsigned char* pixels = this->GetRGBACharPixelData(x, y, x2, y2, front,
//   right);
//   // take ownership of pixels
//   data->SetArray(pixels, desc.Rect.GetWidth() * desc.Rect.GetHeight() * 4, 0);
//   return data->GetNumberOfValues();
...
//   int x, int y, int x2, int y2, unsigned char* data, int front, int blend /*=0*/, int right
//   /*=0*/)
//{
//   (void)front;
//   (void)blend;
