...
- (void)commonInit
{
  ...
  _mySurfaceDescriptor = new wgpu::SurfaceDescriptorFromMetalLayer();
  _mySurfaceDescriptor->layer = [self layer];
...
//----------------------------------------------------------------------------
- (vtkCocoaWebGPURenderWindow*)getVTKRenderWindow
{
  return _myVTKRenderWindow;
}

//----------------------------------------------------------------------------
- (void)setVTKRenderWindow:(vtkCocoaWebGPURenderWindow*)theVTKRenderWindow
{
...
- (void)invokeVTKKeyEvent:(unsigned long)theEventId cocoaEvent:(NSEvent*)theEvent
{
  ...
  vtkCocoaWebGPURenderWindow* renWin = vtkCocoaWebGPURenderWindow::SafeDownCast([self getVTKRenderWindow]);
...
- (void)modifyDPIForBackingScaleFactorOfWindow:(/*nullable*/ NSWindow*)window
{
  ...
  vtkCocoaWebGPURenderWindow* renderWindow = [self getVTKRenderWindow];
  if (renderWindow)
  {
...
//----------------------------------------------------------------------------
- (wgpu::SurfaceDescriptorFromMetalLayer*)getSurfaceDescriptor
{
  return _mySurfaceDescriptor;
}
