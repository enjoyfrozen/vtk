...
Module:    vtkCocoaWebGPURenderWindow.h
 ...
 * @brief   Cocoa WebGPU rendering window
 *
 *
 * vtkCocoaWebGPURenderWindow is a concrete implementation of the abstract
 * class vtkWebGPURenderWindow. It is only available on Mac OS X.
 ...
 * vtkCocoaWebGPURenderWindow uses Objective-C++, and the webGPU and
 * Cocoa APIs. This class's default behaviour is to create an NSWindow and
 * a vtkWebGPURenderWindow which are used together to draw all VTK content.
 *
 * @sa
...
#ifndef vtkCocoaWebGPURenderWindow_h
#define vtkCocoaWebGPURenderWindow_h

#include "vtkWebGPURenderWindow.h"
#include "vtkRenderingWebGPUModule.h" // For export macro

VTK_ABI_NAMESPACE_BEGIN
class VTKRENDERINGWEBGPU_EXPORT vtkCocoaWebGPURenderWindow : public vtkWebGPURenderWindow
{
public:
  /**
   * Instantiate the class.
   */
  static vtkCocoaWebGPURenderWindow* New();

  ///@{
  /**
   * Standard methods for the VTK class.
   */
  vtkTypeMacro(vtkCocoaWebGPURenderWindow, vtkWebGPURenderWindow);
   ...
   * implemented for the vtkCocoaWebGPURenderWindow.  It can only be called
  ...
  /**
   * Remap the window.  This is not implemented for the vtkCocoaWebGPURenderWindow.
   */
  void WindowRemap() override;

  /**
   * Set the preferred window size to full screen.  This is not implemented
   * for the vtkCocoaWebGPURenderWindow.
   */
   ...
   * with the currently activated graphics context.
   */
...
protected:
  vtkCocoaWebGPURenderWindow();
  ~vtkCocoaWebGPURenderWindow() override;
...
private:
  vtkCocoaWebGPURenderWindow(const vtkCocoaWebGPURenderWindow&) = delete;
  void operator=(const vtkCocoaWebGPURenderWindow&) = delete;
...
#endif // vtkCocoaWebGPURenderWindow_h
