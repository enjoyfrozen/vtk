...
void vtkOpenVRRenderWindow::StereoMidpoint()
{
  ...
  if (this->HMD && this->SwapBuffers) // picking does not swap and we don't show it
  {
    ...
    vr::Texture_t leftEyeTexture = {
      (void*)(long)this->FramebufferDescs[vtkVRRenderWindow::LeftEye].ResolveColorTextureId, vr::TextureType_OpenGL,
      vr::ColorSpace_Gamma
    };
...
void vtkOpenVRRenderWindow::StereoRenderComplete()
{
  ...
  if (this->HMD && this->SwapBuffers) // picking does not swap and we don't show it
  {
    ...
    vr::Texture_t rightEyeTexture = {
      (void*)(long)this->FramebufferDescs[vtkVRRenderWindow::RightEye].ResolveColorTextureId, vr::TextureType_OpenGL,
      vr::ColorSpace_Gamma
    };
