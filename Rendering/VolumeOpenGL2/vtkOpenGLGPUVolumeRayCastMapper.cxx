  ...
  vtkRenderer* ren, vtkShaderProgram* prog, vtkVolume* vol, int numberOfSamplers)
{
  ...
  std::vector<float[3]> lightAmbientColor(this->NumberOfLights);
  std::vector<float[3]> lightDiffuseColor(this->NumberOfLights);
  std::vector<float[3]> lightSpecularColor(this->NumberOfLights);
  std::vector<float[3]> lightDirection(this->NumberOfLights);
  ...
  prog->SetUniform3fv("in_lightAmbientColor", this->NumberOfLights, lightAmbientColor.data());
  prog->SetUniform3fv("in_lightDiffuseColor", this->NumberOfLights, lightDiffuseColor.data());
  prog->SetUniform3fv("in_lightSpecularColor", this->NumberOfLights, lightSpecularColor.data());
  prog->SetUniform3fv("in_lightDirection", this->NumberOfLights, lightDirection.data());
  ...
  {
    std::vector<float[3]> lightAttenuation(this->NumberPositionalLights);
    std::vector<float[3]> lightPosition(this->NumberPositionalLights);
    ...
    prog->SetUniform3fv(
      "in_lightAttenuation", this->NumberPositionalLights, lightAttenuation.data());
    prog->SetUniform3fv("in_lightPosition", this->NumberPositionalLights, lightPosition.data());
