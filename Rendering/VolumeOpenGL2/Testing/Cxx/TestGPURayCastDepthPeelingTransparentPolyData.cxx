...
/*===========================================================================*/
/**
 * Tests depth peeling pass with volume rendering while specifically checking
 * for artifacts where the volume intersects geometry with opacity = 0.
 */
...
int TestGPURayCastDepthPeelingTransparentPolyData(int argc, char *argv[])
{
  ...
  scalarOpacity->AddPoint(75, 0.05);
