...
{
  if(abs(ray.dir.x) < 0.001) ray.dir.x = sign(ray.dir.x) * 0.001;
  if(abs(ray.dir.y) < 0.001) ray.dir.y = sign(ray.dir.y) * 0.001;
  if(abs(ray.dir.z) < 0.001) ray.dir.z = sign(ray.dir.z) * 0.001;
}
