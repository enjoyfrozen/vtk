...
void vtkOpenXRModel::CreateTextureObject(vtkOpenGLRenderWindow* win)
{
  ...
  // todo use real texture from gltf data
...
{
  // todo use gltf blob to load model and texture
  // vtkNew<vtkGLTFDocumentLoader> loader;
  // if (!loader->LoadModelMetaDataFromFile(this->GetName()))
  // {
  //   vtkErrorMacro("Error loading model metadata from file ");
