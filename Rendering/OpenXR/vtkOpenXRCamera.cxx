...
vtkOpenXRCamera::vtkOpenXRCamera()
{
  ...
  this->LeftEyeView = vtkMatrix4x4::New();
  this->RightEyeView = vtkMatrix4x4::New();
...
vtkOpenXRCamera::~vtkOpenXRCamera()
{
  ...
  this->LeftEyeView->Delete();
  this->RightEyeView->Delete();
...
void vtkOpenXRCamera::GetHMDEyePoses(vtkRenderer* ren)
{
  ...
  vtkMatrix4x4::Multiply4x4(this->LeftEyeView, physicalToWorldMatrix, this->LeftEyeView);
  ...
  vtkMatrix4x4::Multiply4x4(this->RightEyeView, physicalToWorldMatrix, this->RightEyeView);
}
