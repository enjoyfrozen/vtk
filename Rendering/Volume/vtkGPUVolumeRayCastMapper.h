...
public:
  ...
  ///@{
  /**
   * This parameter acts as a balance between performance
   ...
   * 0.0 means ambient (shadow samples are very close).
   * 1.0 means global (we can capture distant object shadows).
