...
void vtkAxisActor2D::BuildAxis(vtkViewport* viewport)
{
  ...
  if (this->LabelVisibility)
  {
    ...
    for (i = 0; i < this->AdjustedNumberOfLabels; i++)
    {
      ...
      vtkAxisActor2D::SetOffsetPosition(xTick, theta, this->LastMaxLabelSize[0], this->LastMaxLabelSize[1],
  ...
  if (this->Title != nullptr && this->Title[0] != 0 && this->TitleVisibility)
  {
    ...
    {
      offset =
        vtkAxisActor2D::ComputeStringOffset(this->LastMaxLabelSize[0], this->LastMaxLabelSize[1], theta);
    }
