  ...
  if (this->NumberOfLabels)
  {
    ...
    { // NB. Size[0] = width, Size[1] = height
      ...
      this->P->TickBox.Size[1] = this->P->Frame.Size[1] - this->P->TitleBox.Size[1] -
        /*3 * this->TextPad*/ 2 - this->VerticalTitleSeparation;
...
{
  // Since we have already configured the annotations, we can use the leader positions to determine
  // where to draw backgrounds behind leaders Backgrounds behind text can be configured by setting a
  // text property background color
