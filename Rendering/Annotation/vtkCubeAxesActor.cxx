...
void vtkCubeAxesActor::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "X Axis Label Format: " << (this->XLabelFormat != nullptr ? this->XLabelFormat : "") << "\n";
  os << indent << "Y Axis Label Format: " << (this->YLabelFormat != nullptr ? this->YLabelFormat : "") << "\n";
  os << indent << "Z Axis Label Format: " << (this->ZLabelFormat != nullptr ? this->ZLabelFormat : "") << "\n";
