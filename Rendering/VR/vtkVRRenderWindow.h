 ...
 *
 *
 * vtkVRRenderWindow is a concrete implementation of the abstract
 * class vtkRenderWindow. vtkVRRenderer interfaces to the
 * VR graphics library
 *
 * This class and its similar classes are designed to be drop in
 * replacements for VTK. If you link to this module and turn on
 * the CMake option VTK_VR_OBJECT_FACTORY, the object
 * factory mechanism should replace the core rendering classes such as
 * RenderWindow with VR specialized versions. The goal is for VTK
 * programs to be able to use the VR library with little to no
 * changes.
 *
 * This class handles the bulk of interfacing to VR. It supports one
 ...
 * sample code from the VR project.
 *
...
// Todo: remove this define and add it as en enum
#define LEFT_EYE 0
#define RIGHT_EYE 1
...
public:
  ...
  {
    return this->FramebufferDescs[RIGHT_EYE].ResolveFramebufferId;
  }
  ...
  virtual void* GetGenericDisplayId() override { return (void*)this->HelperWindow->GetGenericDisplayId(); }
  virtual void* GetGenericWindowId() override { return (void*)this->HelperWindow->GetGenericWindowId(); }
  virtual void* GetGenericParentId() override { return (void*)nullptr; }
  virtual void* GetGenericContext() override { return (void*)this->HelperWindow->GetGenericContext(); }
  virtual void* GetGenericDrawable() override { return (void*)this->HelperWindow->GetGenericDrawable(); }
...
protected:
  ...
  virtual const char* GetWindowTitleFromAPI() { return "VTK - VR"; }
