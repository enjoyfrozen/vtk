...
void vtkVRMenuRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "PlacedPos: (" << this->PlacedPos[0] << ", " << this->PlacedPos[1] << "," << this->PlacedPos[2] << ")\n";
  os << indent << "PlacedDOP: (" << this->PlacedDOP[0] << ", " << this->PlacedDOP[1] << "," << this->PlacedDOP[2] << ")\n";
  os << indent << "PlacedVUP: (" << this->PlacedVUP[0] << ", " << this->PlacedVUP[1] << "," << this->PlacedVUP[2] << ")\n";
  os << indent << "PlacedVRight: (" << this->PlacedVRight[0] << ", " << this->PlacedVRight[1] << "," << this->PlacedVRight[2] << ")\n";
  os << indent << "PlacedOrientation: (" << this->PlacedOrientation[0] << ", " << this->PlacedOrientation[1] << "," << this->PlacedOrientation[2] << ")\n";
}
