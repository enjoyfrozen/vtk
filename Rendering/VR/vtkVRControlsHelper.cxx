...
Module:    vtkVRControlsHelper.cxx
...
void vtkVRControlsHelper::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  os << indent << "ControlPositionLC: (" << this->ControlPositionLC[0] << ", " << this->ControlPositionLC[1] << "," << this->ControlPositionLC[2] << ")\n";
  os << indent << "LastPhysicalTranslation: (" << this->LastPhysicalTranslation[0] << ", " << this->LastPhysicalTranslation[1] << ")\n";
  os << indent << "LastEventPosition: (" << this->LastEventPosition[0] << ", " << this->LastEventPosition[1] << "," << this->LastEventPosition[2] << ")\n";
  os << indent << "LastEventOrientation: (" << this->LastEventOrientation[0] << ", " << this->LastEventOrientation[1] << ", " << this->LastEventOrientation[2] << "," << this->LastEventOrientation[3] << ")\n";
