...
void vtkTDxMacDeviceMessageHandler(
  io_connect_t connection, natural_t messageType, void* messageArgument);

class vtkLessThanClientID
{
public:
  bool operator()(const UInt16& id1, const UInt16& id2) const { return id1 < id2; }
};
...
void vtkTDxMacDevice::Initialize()
{
  ...
  unsigned char* pString = this->CStringToPascalString(this->ClientApplicationName);
  ...
  this->ClientID = RegisterConnexionClient(
    kConnexionClientWildcard, '\0', kConnexionClientModeTakeOver, kConnexionMaskAll);
