...
class VTKRENDERINGTDX_EXPORT vtkTDxWinDevice : public vtkTDxDevice
{
public:
...
private:
  vtkTDxWinDevice(const vtkTDxWinDevice&) = delete;
  void operator=(const vtkTDxWinDevice&) = delete;
};
