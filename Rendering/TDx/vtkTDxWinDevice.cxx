...
HRESULT HresultCodes[13] = { S_OK, REGDB_E_CLASSNOTREG, CLASS_E_NOAGGREGATION, E_NOINTERFACE,
  E_POINTER, E_ABORT, E_ACCESSDENIED, E_FAIL, E_HANDLE, E_INVALIDARG, E_NOTIMPL, E_OUTOFMEMORY,
  E_UNEXPECTED };

const char* HresultStrings[13] = { "S_OK", "REGDB_E_CLASSNOTREG", "CLASS_E_NOAGGREGATION",
  "E_NOINTERFACE", "E_POINTER", "E_ABORT", "E_ACCESSDENIED", "E_FAIL", "E_HANDLE", "E_INVALIDARG",
  "E_NOTIMPL", "E_OUTOFMEMORY", "E_UNEXPECTED" };
