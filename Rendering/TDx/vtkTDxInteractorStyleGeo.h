 ...
 * @brief   interactive manipulation of the camera with a 3DConnexion device, similar to google
 * earth
 *
 *
...
public:
   ...
   */
  virtual void OnMotionEvent(vtkTDxMotionEventInfo* motionInfo) override;
