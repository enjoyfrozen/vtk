...
void vtkBlueObeliskDataParser::NewAtomFinished()
{
  ...
  vtkBlueObeliskDataParser::ResizeAndSetValue(vtkBlueObeliskDataParser::ToLower(this->CurrentSymbol), this->Target->LowerSymbols, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentName, this->Target->Names, index);
  // vtkBlueObeliskDataParser::ToLower will modify the input string, so this
  // must follow this->Name
  vtkBlueObeliskDataParser::ResizeAndSetValue(vtkBlueObeliskDataParser::ToLower(this->CurrentName), this->Target->LowerNames, index);
  ...
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentExactMass, this->Target->ExactMasses, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentIonizationEnergy, this->Target->IonizationEnergies, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentElectronAffinity, this->Target->ElectronAffinities, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(
    this->CurrentPaulingElectronegativity, this->Target->PaulingElectronegativities, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentCovalentRadius, this->Target->CovalentRadii, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentVDWRadius, this->Target->VDWRadii, index);
  ...
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentBoilingPoint, this->Target->BoilingPoints, index);
  vtkBlueObeliskDataParser::ResizeAndSetValue(this->CurrentMeltingPoint, this->Target->MeltingPoints, index);
