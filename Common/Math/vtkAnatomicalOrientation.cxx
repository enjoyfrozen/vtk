...
//----------------------------------------------------------------------------
const vtkAnatomicalOrientation::Axis vtkAnatomicalOrientation::ValidAxes[6] = { Axis::L, Axis::R,
  Axis::P, Axis::A, Axis::S, Axis::I };
...
{
  return this->X != Axis::None && this->Y != Axis::None && this->Z != Axis::None &&
    this->Z != this->Y && this->Z != this->X && this->Y != this->X &&
    this->Z != AxisInverse(this->Y) && this->Z != AxisInverse(this->X) &&
...
//----------------------------------------------------------------------------
void vtkAnatomicalOrientation::GetTransformTo(
  vtkAnatomicalOrientation finalOrientation, double transform[9]) const
{
  for (int i = 0; i < 3; ++i)
  {
    for (int j = 0; j < 3; ++j)
