...
int Test_csd()
{
  ...
  // Numbers have been generated using scipy. Assuming signal, complexSignal sample_rate and window
  // are the same : scipy.signal.csd(signal, signal, sample_rate, window, nfft, noverlap, nfft,
  // False, onesided, 'spectrum')
  const std::vector<vtkFFT::ScalarNumber> expected_spectrum = { 3.09720960e-04, 6.87180446e-04,
    9.53471680e-04, 1.77702632e-03, 5.80014112e-03, 4.78877655e-01, 8.66665619e-03, 1.88031998e-03,
    8.02178225e-04, 4.45530776e-04, 2.85094629e-04, 1.99252385e-04, 1.47864401e-04, 1.14580456e-04,
    9.17279964e-05, 7.53179220e-05, 6.31079993e-05, 5.37579837e-05, 4.64259031e-05, 4.05606037e-05,
    3.57886127e-05, 3.18492915e-05, 2.85560685e-05, 2.57724052e-05, 2.33964200e-05, 2.13507743e-05,
    1.95758546e-05, 1.80250762e-05, 1.66615834e-05, 1.54558896e-05, 1.43841629e-05, 1.34269624e-05,
    1.25682935e-05, 1.17948939e-05, 1.10956871e-05, 1.04613601e-05, 9.88403427e-06, 9.35700593e-06,
    8.87454018e-06, 8.43170640e-06, 8.02424543e-06, 7.64846186e-06, 7.30113611e-06, 6.97945214e-06,
    6.68093782e-06, 6.40341531e-06, 6.14495974e-06, 5.90386446e-06, 5.67861181e-06, 5.46784840e-06,
    5.27036409e-06, 5.08507403e-06, 4.91100334e-06, 4.74727394e-06, 4.59309312e-06, 4.44774379e-06,
    4.31057587e-06, 4.18099896e-06, 4.05847580e-06, 3.94251662e-06, 3.83267418e-06, 3.72853943e-06,
    3.62973759e-06, 3.53592483e-06, 3.44678517e-06, 3.36202790e-06, 3.28138513e-06, 3.20460969e-06,
    3.13147326e-06, 3.06176466e-06, 2.99528834e-06, 2.93186301e-06, 2.87132044e-06, 2.81350432e-06,
    2.75826932e-06, 2.70548014e-06, 2.65501072e-06, 2.60674352e-06, 2.56056883e-06, 2.51638416e-06,
    2.47409371e-06, 2.43360787e-06, 2.39484272e-06, 2.35771967e-06, 2.32216502e-06, 2.28810967e-06,
    2.25548875e-06, 2.22424135e-06, 2.19431024e-06, 2.16564164e-06, 2.13818498e-06, 2.11189269e-06,
    2.08671999e-06, 2.06262477e-06, 2.03956735e-06, 2.01751039e-06, 1.99641872e-06, 1.97625921e-06,
    1.95700066e-06, 1.93861370e-06, 1.92107066e-06, 1.90434550e-06, 1.88841370e-06, 1.87325222e-06,
    1.85883936e-06, 1.84515476e-06, 1.83217929e-06, 1.81989500e-06, 1.80828506e-06, 1.79733375e-06,
    1.78702635e-06, 1.77734912e-06, 1.76828931e-06, 1.75983503e-06, 1.75197529e-06, 1.74469994e-06,
    1.73799966e-06, 1.73186588e-06, 1.72629085e-06, 1.72126752e-06, 1.71678958e-06, 1.71285144e-06,
    1.70944819e-06, 1.70657560e-06, 1.70423012e-06, 1.70240885e-06, 1.70110954e-06, 1.70033059e-06,
    8.75237474e-13, 8.73766709e-13, 8.72565823e-13, 8.71633331e-13, 8.70968084e-13, 8.70569263e-13,
    4.35218189e-13 };
  // scipy.signal.csd(complexSignal, complexSignal, sample_rate, window, nfft, noverlap, nfft,
  // False, onesided, 'density')
  const std::vector<vtkFFT::ScalarNumber> expected_complex_density = { 1.58577131e-10,
  ...
  // 'density', mode='complex') print(np.transpose(result)[1])
  const std::vector<vtkFFT::ComplexNumber> expected_stft = { vtkFFT::ComplexNumber{
                                                               -1.04453772e-05, +0.00000000e+00 },
    vtkFFT::ComplexNumber{ -1.08899718e-05, +2.42711241e-06 },
    vtkFFT::ComplexNumber{ -1.24639215e-05, +5.50894674e-06 },
    vtkFFT::ComplexNumber{ -1.63062675e-05, +1.06608924e-05 },
    vtkFFT::ComplexNumber{ -2.80052035e-05, +2.39474184e-05 },
    vtkFFT::ComplexNumber{ -2.41221833e-04, +2.51665381e-04 },
    vtkFFT::ComplexNumber{ 3.07955556e-05, -3.74575082e-05 },
    vtkFFT::ComplexNumber{ 1.36619618e-05, -1.87554989e-05 },
    vtkFFT::ComplexNumber{ 8.54211347e-06, -1.29159588e-05 },
    vtkFFT::ComplexNumber{ 6.12883187e-06, -1.00130607e-05 },
    vtkFFT::ComplexNumber{ 4.74760160e-06, -8.25282435e-06 },
    vtkFFT::ComplexNumber{ 3.86522519e-06, -7.05933012e-06 },
    vtkFFT::ComplexNumber{ 3.25982984e-06, -6.19008306e-06 },
    vtkFFT::ComplexNumber{ 2.82300689e-06, -5.52478926e-06 },
    vtkFFT::ComplexNumber{ 2.49572979e-06, -4.99675611e-06 },
    vtkFFT::ComplexNumber{ 2.24324048e-06, -4.56589683e-06 },
    vtkFFT::ComplexNumber{ 2.04381678e-06, -4.20658848e-06 },
    vtkFFT::ComplexNumber{ 1.88323268e-06, -3.90164116e-06 },
    vtkFFT::ComplexNumber{ 1.75181199e-06, -3.63906305e-06 },
    vtkFFT::ComplexNumber{ 1.64276396e-06, -3.41021492e-06 },
    vtkFFT::ComplexNumber{ 1.55119576e-06, -3.20870271e-06 },
    vtkFFT::ComplexNumber{ 1.47350189e-06, -3.02968447e-06 },
    vtkFFT::ComplexNumber{ 1.40697332e-06, -2.86942077e-06 },
    vtkFFT::ComplexNumber{ 1.34953977e-06, -2.72497386e-06 },
    vtkFFT::ComplexNumber{ 1.29959521e-06, -2.59400108e-06 },
    vtkFFT::ComplexNumber{ 1.25587706e-06, -2.47460944e-06 },
    vtkFFT::ComplexNumber{ 1.21738086e-06, -2.36525130e-06 },
    vtkFFT::ComplexNumber{ 1.18329883e-06, -2.26464795e-06 },
    vtkFFT::ComplexNumber{ 1.15297505e-06, -2.17173293e-06 },
    vtkFFT::ComplexNumber{ 1.12587213e-06, -2.08560911e-06 },
    vtkFFT::ComplexNumber{ 7.98845794e-07, -2.38654708e-07 },
    vtkFFT::ComplexNumber{ 7.98474373e-07, -2.28513445e-07 },
    vtkFFT::ComplexNumber{ 7.98121664e-07, -2.18448383e-07 },
    vtkFFT::ComplexNumber{ 7.97787183e-07, -2.08455624e-07 },
    vtkFFT::ComplexNumber{ 7.97470475e-07, -1.98531373e-07 },
    vtkFFT::ComplexNumber{ 7.97171113e-07, -1.88671928e-07 },
    vtkFFT::ComplexNumber{ 7.96888699e-07, -1.78873676e-07 },
    vtkFFT::ComplexNumber{ 7.96622858e-07, -1.69133084e-07 },
    vtkFFT::ComplexNumber{ 7.96373243e-07, -1.59446699e-07 },
    vtkFFT::ComplexNumber{ 7.96139529e-07, -1.49811137e-07 },
    vtkFFT::ComplexNumber{ 7.95921415e-07, -1.40223082e-07 },
    vtkFFT::ComplexNumber{ 7.95718621e-07, -1.30679280e-07 },
    vtkFFT::ComplexNumber{ 7.95530889e-07, -1.21176533e-07 },
    vtkFFT::ComplexNumber{ 7.95357983e-07, -1.11711696e-07 },
    vtkFFT::ComplexNumber{ 7.95199685e-07, -1.02281675e-07 },
    vtkFFT::ComplexNumber{ 7.95055797e-07, -9.28834157e-08 },
    vtkFFT::ComplexNumber{ 7.94926141e-07, -8.35139072e-08 },
    vtkFFT::ComplexNumber{ 7.94810556e-07, -7.41701734e-08 },
    vtkFFT::ComplexNumber{ 7.94708899e-07, -6.48492707e-08 },
    vtkFFT::ComplexNumber{ 7.94621046e-07, -5.55482839e-08 },
    vtkFFT::ComplexNumber{ 7.94546889e-07, -4.62643224e-08 },
    vtkFFT::ComplexNumber{ 7.94486338e-07, -3.69945167e-08 },
    vtkFFT::ComplexNumber{ 7.94439319e-07, -2.77360148e-08 },
    vtkFFT::ComplexNumber{ 7.94405774e-07, -1.84859787e-08 },
    vtkFFT::ComplexNumber{ 7.94385664e-07, -9.24158072e-09 },
    vtkFFT::ComplexNumber{ 7.94378963e-07, +0.00000000e+00 } };

  // scipy.signal.csd(signal, signal, sample_rate, window, nfft, noverlap, nfft, False, onesided,
  // 'density')
  std::vector<vtkFFT::ScalarNumber> result =
    vtkFFT::Csd(signal, window, sample_rate, noverlap, false, onesided, vtkFFT::Scaling::Density);
  if (!::FuzzyCompare(result, expected_density, 1e-14))
  {
  ...
  if (!::FuzzyCompare(result, expected_spectrum, 1e-8))
  {
  ...
  if (!::FuzzyCompare(result, expected_spectrum_detrend, 1e-8))
  {
  ...
  if (!::FuzzyCompare(result, expected_complex_density, 1e-14))
  {
  ...
  if (!::FuzzyCompare(vtkResult, expected_spectrum_detrend, 1e-8))
  {
  ...
  for (std::size_t i = 0; i < expected_stft.size(); ++i)
  {
    if (!FuzzyCompare(expected_stft[i], resSpectro[i + shape[1]], 1e-9))
    {
