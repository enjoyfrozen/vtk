 ...
 * Example output: "Left-Posterior-Superior (LPS)"
 */
std::ostream& operator<<(std::ostream& stream, const vtkAnatomicalOrientation& rhs)
{
  stream << rhs.GetAsString("-");
  stream << " (";
  stream << rhs.GetAsAcronym();
  stream << ")";
  return stream;
}
//@}
 ...
 * Example output: "Left-Posterior-Superior (LPS)"
 */
std::ostream& operator<<(std::ostream& stream, const vtkAnatomicalOrientation::Axis& rhs)
{
  stream << vtkAnatomicalOrientation::AxisToString(rhs);
  stream << " (";
  stream << vtkAnatomicalOrientation::AxisToChar(rhs);
  stream << ")";
  return stream;
}
//@}
