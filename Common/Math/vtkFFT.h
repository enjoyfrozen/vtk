...
public:
  ...
  static void GenerateKernel1D(Array1D* kernel, std::size_t n, WindowGenerator generator);
  ...
  static void GenerateKernel2D(
    Array2D* kernel, std::size_t n, std::size_t m, WindowGenerator generator);
...
//------------------------------------------------------------------------------
template <typename Array1D>
void vtkFFT::GenerateKernel1D(Array1D* kernel, std::size_t n, WindowGenerator generator)
{
