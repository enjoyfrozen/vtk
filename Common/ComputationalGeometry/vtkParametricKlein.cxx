                                  ...
                                  double Duvw[9])
{
  ...
  double subY = 80 * cv * pow(cu, 7) * su + 48 * cv * pow(cu, 6)
                - 80 * cv * pow(cu, 5) * su
                - 48 * cv * pow(cu, 4) - 5 * cv * pow(cu, 3) * su - 3 * cv * pow(cu,
                    2) +
  ...
  // The derivatives
  Du[0] = 2.0 / 15.0 * su * subX - 2.0 / 15.0 * cu * (5.0 * cv * pow(cu,
          2)
  ...
  Dv[1] = -1.0 / 15.0 * su * (-80.0 * sv * pow(cu,
                              7) * su - 48.0 * sv * pow(cu, 6)
                              + 80.0 * sv * pow(cu, 5) * su + 48.0 * sv * pow(cu,
                                  4) + 5.0 * sv * pow(cu, 3) * su
