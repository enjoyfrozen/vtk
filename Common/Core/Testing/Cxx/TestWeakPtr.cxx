...
int TestWeakPtr(int, char*[])
{
  ...
  // Test comparisons.
  {
    ...
    if (weak0a != weak0a)
    {
      ERROR("default constructed is truthy for `weak0a != weak0a`");
    }
    if (!(weak0a == weak0a))
    {
      ERROR("default constructed is false-y for `weak0a == weak0a`");
    }

    if (weak1a != weak1a)
    {
      ERROR("ptr constructed is truthy for `weak1a != weak1a`");
    }
    if (!(weak1a == weak1a))
    {
      ERROR("ptr constructed is false-y for `weak1a == weak1a`");
    }
    ...
    if (!(weak1a != weak2))
    {
      ERROR("ptr constructed is false-y for `weak1a == weak2`");
    }
  }
