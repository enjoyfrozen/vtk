...
typedef vtkTypeList::Unique<
  vtkTypeList_Create_10(
    ...
    vtkScaledSOADataArrayTemplate<unsigned char>,
    vtkScaledSOADataArrayTemplate<vtkIdType>
  )
>::Result Arrays;
...
struct Arrays
{
  ...
  static vtkScaledSOADataArrayTemplate<double>        *soaDouble;
  static vtkScaledSOADataArrayTemplate<float>         *soaFloat;
  static vtkScaledSOADataArrayTemplate<int>           *soaInt;
  static vtkScaledSOADataArrayTemplate<unsigned char> *soaUnsignedChar;
  static vtkScaledSOADataArrayTemplate<vtkIdType>     *soaIdType;
...
vtkScaledSOADataArrayTemplate<double>        *Arrays::soaDouble;
vtkScaledSOADataArrayTemplate<float>         *Arrays::soaFloat;
vtkScaledSOADataArrayTemplate<int>           *Arrays::soaInt;
vtkScaledSOADataArrayTemplate<unsigned char> *Arrays::soaUnsignedChar;
vtkScaledSOADataArrayTemplate<vtkIdType>     *Arrays::soaIdType;
...
typedef vtkTypeList_Create_5(vtkScaledSOADataArrayTemplate<double>,
                             vtkScaledSOADataArrayTemplate<float>,
                             vtkScaledSOADataArrayTemplate<int>,
                             vtkScaledSOADataArrayTemplate<unsigned char>,
                             vtkScaledSOADataArrayTemplate<vtkIdType>) SoAArrayList;
...
int TestDispatch2ByArray()
{
       ...
       itEnd1 = Arrays::allArrays.end(); it1 != itEnd1; ++it1)
  {
    ...
    bool array1Valid =
        array1->GetArrayType() == vtkAbstractArray::ScaleSoADataArrayTemplate;
...
int TestDispatch2ByArrayWithSameValueType()
{
       ...
       itEnd1 = Arrays::allArrays.end(); it1 != itEnd1; ++it1)
  {
         ...
         itEnd2 = Arrays::allArrays.end(); it2 != itEnd2; ++it2)
    {
      vtkDataArray *array2 = *it2;
      bool array2Valid =
          array2->GetArrayType() == vtkAbstractArray::ScaleSoADataArrayTemplate &&
...
int TestDispatch3ByArray()
{
  ...
  // Array1: Scale SoA
  // Array2: AoS
  // Array3: AoS/Scale SoA float arrays
...
Arrays::Arrays()
{
  ...
  soaDouble = vtkScaledSOADataArrayTemplate<double>::New();
  soaFloat = vtkScaledSOADataArrayTemplate<float>::New();
  soaInt = vtkScaledSOADataArrayTemplate<int>::New();
  soaUnsignedChar = vtkScaledSOADataArrayTemplate<unsigned char>::New();
  soaIdType = vtkScaledSOADataArrayTemplate<vtkIdType>::New();
...
//------------------------------------------------------------------------------
int TestScaledSOADataArrayDispatchers(int, char *[])
{
  int errors = 0;
  Arrays arrays;
