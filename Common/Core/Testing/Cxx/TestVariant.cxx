...
int TestVariant(int, char*[])
{
  ...
  if (doubleToString.ToString(vtkVariant::FIXED, 8) != "103.31700000")
  {
    cerr << "double to string complex conversion failed with fixed formatting.\n";
    errors++;
  }
  if (doubleToString.ToString(vtkVariant::SCIENTIFIC, 2) != "1.03e+02")
  {
    cerr << "double to string complex conversion failed with scientific formatting.\n";
    errors++;
  }
  if (doubleToString.ToString(vtkVariant::HEXFLOAT, 10) != "0x1.9d449ba5e353fp+6")
  {
    cerr << "double to string complex conversion failed with hoxfloat formatting.\n";
    errors++;
  }
