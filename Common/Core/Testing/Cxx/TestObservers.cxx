...
public:
  ...
  void CallbackWithArguments(vtkObject*, unsigned long event, void*) { vtkHandler::EventCounts[event]++; }
};
...
public:
  ...
  void CallbackWithArguments(vtkObject*, unsigned long event, void*) { OtherHandler::EventCounts[event]++; }
};
