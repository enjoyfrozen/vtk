...
vtkTypeBool vtkObjectFactory::GetEnableFlag(const char* className, const char* subclassName) VTK_FUTURE_CONST
{
  for (int i = 0; i < this->OverrideArrayLength; i++)
  {
    if (strcmp(this->OverrideClassNames[i], className) == 0)
...
vtkTypeBool vtkObjectFactory::HasOverride(const char* className, const char* subclassName) VTK_FUTURE_CONST
{
  for (int i = 0; i < this->OverrideArrayLength; i++)
  {
    if (strcmp(this->OverrideClassNames[i], className) == 0)
