...
#if defined VTK_GDA_VALUERANGE_INSTANTIATING
  {
...
#define vtkInstantiateComputeScalarRangeMacro(ArrayT, NumComps, ...)                               \
  ...
  vtkInstantiateComputeScalarRangeFuncMacro(                                                       \
    ArrayT, unsigned long, NumComps, AllValues, __VA_ARGS__);                                      \
  vtkInstantiateComputeScalarRangeFuncMacro(ArrayT, long long, NumComps, AllValues, __VA_ARGS__);  \
  vtkInstantiateComputeScalarRangeFuncMacro(                                                       \
    ArrayT, unsigned long long, NumComps, AllValues, __VA_ARGS__);                                 \
  ...
  vtkInstantiateComputeScalarRangeFuncMacro(                                                       \
    ArrayT, unsigned long, NumComps, FiniteValues, __VA_ARGS__);                                   \
  vtkInstantiateComputeScalarRangeFuncMacro(                                                       \
    ArrayT, long long, NumComps, FiniteValues, __VA_ARGS__);                                       \
  vtkInstantiateComputeScalarRangeFuncMacro(                                                       \
    ArrayT, unsigned long long, NumComps, FiniteValues, __VA_ARGS__)
