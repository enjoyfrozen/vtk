...
int TestPolyhedralCells(int argc, char* argv[])
{
  // create the a cube
  ...
  vtkSmartPointer<vtkCellArray> faceLocations = vtkSmartPointer<vtkCellArray>::New();
  ...
  vtkSmartPointer<vtkIdTypeArray> faceStream = vtkSmartPointer<vtkIdTypeArray>::New();
  vtkSmartPointer<vtkIdTypeArray> faceStreamLocations = vtkSmartPointer<vtkIdTypeArray>::New();
  vtkUnstructuredGrid::CopyPolyhedronToFaceStream(
    facesHandle, faceLocationsHandle, faceStream, faceStreamLocations);

  vtkSmartPointer<vtkUnstructuredGrid> ugrid1 = vtkSmartPointer<vtkUnstructuredGrid>::New();
  ...
  vtkPolyhedron* polyhedron_copy = static_cast<vtkPolyhedron*>(ugrid1->GetCell(0));
