...
{
  vtkSmartPointer<vtkLagrangeWedge> w =
...
int TestInterpolationFunction(vtkSmartPointer<vtkLagrangeWedge> cell,
...
void InterpolateDerivsNumeric(vtkSmartPointer<vtkLagrangeWedge> cell,
                              double pcoords[3],
                              double* derivs,
                              double eps = VTK_EPSILON)
{
...
int TestInterpolationDerivs(vtkSmartPointer<vtkLagrangeWedge> cell,
                            double eps = VTK_EPSILON)
{
  int numPts = cell->GetNumberOfPoints();
