...
public:
   ...
   * CopyAllOn/Off
   *
   * @warning There can be compiler misunderstanding on those signatures on litteral `0` inputs.
   * To tell the compiler that `0` is a `vtkIdType`, please litterally write `vtkIdType(0)`.
   */
  ...
  void CopyTuples(vtkAbstractArray* fromData, vtkAbstractArray* toData, vtkIdList* fromIds,
