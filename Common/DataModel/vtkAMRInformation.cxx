...
{
  return !((q[0] < gbounds[0]) || (q[0] > gbounds[1]) || (q[1] < gbounds[2]) ||
    (q[1] > gbounds[3]) || (q[2] < gbounds[4]) || (q[2] > gbounds[5]));
}
...
unsigned int* vtkAMRInformation::GetParents(
...
bool vtkAMRInformation::GetCoarsenedAMRBox(
