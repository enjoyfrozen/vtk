...
void vtkStructuredData::GetPointCells(vtkIdType ptId, vtkIdList* cellIds, VTK_FUTURE_CONST int dim[3])
{
  vtkIdType cellDim[3];
...
//------------------------------------------------------------------------------
bool vtkStructuredData::IsCellVisible(vtkIdType cellId, VTK_FUTURE_CONST int dimensions[3], int dataDescription,
