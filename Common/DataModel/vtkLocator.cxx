...
//------------------------------------------------------------------------------
vtkLocator::LinearTransformationInformation::LinearTransformationInformation()
  : UseTransform(false)
{
}

//------------------------------------------------------------------------------
void vtkLocator::LinearTransformationInformation::InverseTransformPointIfNeeded(
...
//------------------------------------------------------------------------------
void vtkLocator::LinearTransformationInformation::TransformPointIfNeeded(
  const double x[3], double xtransform[3])
{
  if (!this->UseTransform)
  {
...
//------------------------------------------------------------------------------
void vtkLocator::LinearTransformationInformation::InverseTransformNormalIfNeeded(
...
//------------------------------------------------------------------------------
void vtkLocator::LinearTransformationInformation::TransformNormalIfNeeded(
  const double n[3], double ntransform[3])
{
  if (!this->UseTransform)
  {
