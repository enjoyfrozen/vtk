 ...
 *
 * vtkLinearTransformCellLocator can accept any cell locator, e.g. vtkStaticCellLocator,
 * vtkCellLocator, calculate the transformation matrix of the original dataset versus the new
 * dataset, and then use the cell locator adaptor to perform cell locator operations.
 * The transformation matrix is computed using the https://en.wikipedia.org/wiki/Kabsch_algorithm.
 * IsLinearTransformation validates if the dataset is a linear transformation of the original.
 *
...
public:
  ...
  /**
   * This function returns if the dataset of the locator and the set dataset is a linear
   * transformation. The value is computed after calling BuildLocator().
   */
