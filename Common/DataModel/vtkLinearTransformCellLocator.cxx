...
{
  auto initialPointsData = GetPoints(this->CellLocator->GetDataSet())->GetData();
  auto newPointsData = GetPoints(this->DataSet)->GetData();
...
//------------------------------------------------------------------------------
void vtkLinearTransformCellLocator::FindCellsWithinBounds(double* bbox, vtkIdList* cells)
{
