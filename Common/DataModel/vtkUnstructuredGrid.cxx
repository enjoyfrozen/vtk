...
struct RemoveGhostCellsWorker
{
  ...
  void operator()(ArrayT1* inputOffsets, ArrayT2* outputOffsets,
    ...
    vtkIdTypeArray* inputFaces, vtkIdTypeArray* inputFaceLocations,
    vtkIdTypeArray* outputFaces, vtkIdTypeArray* outputFaceLocations)
  {
    ...
    std::vector<vtkIdType> pointIdRedirectionMap (numPoints);
    std::fill(pointIdRedirectionMap.begin(), pointIdRedirectionMap.end(), -1);
