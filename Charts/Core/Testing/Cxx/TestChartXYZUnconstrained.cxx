...
int TestChartXYZUnconstrained(int, char*[])
{
  // Implicitly tested here:
  // - clipping planes can be disabled in all dimensions. (Clipping in Z is a pain.)
  // - user can zoom while the box scales the same amount. (It can be confusing otherwise.)
  // - The plot is allowed to escape the specified geometry/margins when SetFitToScene == false
  ...
  chart->SetScaleBoxWithPlot(true);
