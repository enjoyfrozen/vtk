...
{
  if (this->Margins == margins && SizeStrategy == USE_MARGINS_AND_SCENE_SIZE)
  {
    return;
  }
  SizeStrategy = USE_MARGINS_AND_SCENE_SIZE;
...
std::size_t vtkChartXYZ::GetPlotHeight() const
{
  ...
  if (this->Margins[0] + this->Margins[2] > std::size_t(this->Scene->GetSceneHeight()))
  {
    return 0;
  }
