 ...
 * ranks. The design is based one `MPI_Alltoall` enabling algorithms to exchange
...
public:
   ...
   *
   * This is a collective operation is must be called on all ranks in the MPI
   * group irrespective of whether any rank is send or receiving data.
   *
