...
ExtentType PeelOffGhostLayers(GridDataSetT* grid)
{
...

  {
    ...
    // if a shift back lands on a ghost or not. If it lands on a ghost, then the corresponding
    // dimension needs to be peeled up to the current position of the cursor. If not, it doesn't.
