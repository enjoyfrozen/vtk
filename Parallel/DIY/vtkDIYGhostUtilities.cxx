...
//----------------------------------------------------------------------------
template<class PointSetT>
void InitialiazeBlocksForUnstructuredData(diy::Master& master,
...
//----------------------------------------------------------------------------
void vtkDIYGhostUtilities::InitialiazeBlocks(diy::Master& vtkNotUsed(master),
...
//----------------------------------------------------------------------------
void vtkDIYGhostUtilities::InitialiazeBlocks(diy::Master& master,
...
{
  InitialiazeBlocksForUnstructuredData(master, inputs);
