...
//----------------------------------------------------------------------------
static void InflateBoundingBoxIfNecessaryImpl(vtkPointSet* input,
    const double* bounds, vtkBoundingBox& bb)
{
...
//----------------------------------------------------------------------------
template <>
static void InflateBoundingBoxIfNecessary(vtkPolyData* input,
    const double* bounds, vtkBoundingBox& bb)
{
