...
int VTK_PARSE_MAIN(int argc, char* argv[])
{
  ...
  // TODO: Constants must be declared at the very end of the unity cxx file.
  // /* get the constant translation file */
  // const char* translation_file_name = NULL;
  // for (int i = 0; i < argc; ++i)
  // {
  //   if (!strcmp(argv[i], "--js-constant-translation"))
  //   {
  //     translation_file_name = argv[i + 1];
  //     break;
  //   }
  // }

  // fp = fopen(translation_file_name, "w+");
  ...
  //   if (hinfo || data == file_info->MainClass)
  //   {
  //     /* from Module['scope.enum'] to Module['scope']['enum']*/
  //     vtkWrapJavaScript_TranslateEnumTypes(fp, module, data->Name, "  ", data);

  //     /* create any constant types defined in the class */
  //     vtkWrapJavaScript_GenerateConstants(fp, module, data->Name, "  ", data);
  //   }
  // }
  // /* close the file */
  // fclose(fp);
