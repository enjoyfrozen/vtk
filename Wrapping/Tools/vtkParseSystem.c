...
/**
 * On Win32, this interpretes fname as UTF8 and then calls wstat().
 * On other systems, it simply calls stat().
 */
int system__stat(const char* pathname, struct _stat* statbuf)
{
