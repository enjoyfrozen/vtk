...
if(CMAKE_COMPILER_IS_GNUCXX OR CMAKE_COMPILER_IS_CLANGXX)
  ...
  if(VTK_ENABLE_SANITIZER)
    ...
    if (UNIX AND NOT APPLE)
      ...
      # runtime when in use.
      if (VTK_SANITIZER MATCHES "address")
      ...
      # Tests using external binaries need additional help to load the UBSan
      # runtime when in use.
      if (VTK_SANITIZER MATCHES "undefined")
        find_library(VTK_UBSAN_LIBRARY
          NAMES libubsan.so.1
          DOC "UBSan library")
        mark_as_advanced(VTK_UBSAN_LIBRARY)
