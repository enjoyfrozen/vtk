...
if(OPENGL_FOUND)
  ...
  if(OpenGL_GLES2_FOUND AND NOT TARGET OpenGL::GLES2)
    if(EMSCRIPTEN)
      ...
      # be used. (1 or 2)
      # For old version of EMSCRIPTEN < 1.39.5 the user will have to register
      # its own "-s USE_WEBGL1=1 or -s USE_WEBGL2=1"
      set(_opengl_gles_compile_options "SHELL:-s FULL_ES2=1")
      if(EMSCRIPTEN_VERSION VERSION_GREATER_EQUAL 1.39.5)
        list(APPEND _opengl_gles_compile_options
    ...
    if(IS_ABSOLUTE "${OPENGL_gles2_LIBRARY}")
      ...
      if(EMSCRIPTEN)
        set_target_properties(OpenGL::GLES2 PROPERTIES INTERFACE_COMPILE_OPTIONS
                              _opengl_gles_compile_options
        )
      else()
    ...
    unset(_opengl_gles_compile_options)
  endif()
  ...
  if(OpenGL_GLES3_FOUND AND NOT TARGET OpenGL::GLES3)
    if(EMSCRIPTEN)
      ...
      set(_opengl_gles_compile_options "SHELL:-s FULL_ES3=1")
      if(EMSCRIPTEN_VERSION VERSION_GREATER_EQUAL 1.39.5)
        list(APPEND _opengl_gles_compile_options
    ...
    if(IS_ABSOLUTE "${OPENGL_gles3_LIBRARY}")
      ...
      if(EMSCRIPTEN)
        set_target_properties(OpenGL::GLES3 PROPERTIES INTERFACE_COMPILE_OPTIONS
                              _opengl_gles_compile_options)
      else()
