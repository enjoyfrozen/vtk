...
#
# Instructions:
# 2. Run ccmake -DVTK_ARM_BUILD=ON /path/to/vtk/source
# 5. Generate and make
#
...
# Now cross-compile VTK with the arm toolchain
set(arm_cmake_flags
  ...
  -DModule_vtkTestingCore:BOOL=OFF
  -DModule_vtkTestingRendering:BOOL=OFF
  -DModule_vtkRenderingVolumeOpenGL2:BOOL=OFF
)

macro(crosscompile out_build_dir)
  set(_ARM_DIR "armv")
  set(_ARM_TOOLCHAIN ${BUILD_DIR}/${_ARM_DIR}-toolchain.cmake)
  configure_file(${CMAKE_CURRENT_SOURCE_DIR}/CMake/arm.toolchain.cmake.in
    ${_ARM_TOOLCHAIN} @ONLY)
  ExternalProject_Add(
    "arm"
    SOURCE_DIR ${CMAKE_SOURCE_DIR}
    PREFIX ${PREFIX_DIR}/${_ARM_DIR}
    BINARY_DIR ${BUILD_DIR}/${_ARM_DIR}
    INSTALL_DIR ${INSTALL_DIR}/${_ARM_DIR}
    DEPENDS vtk-compile-tools
    BUILD_ALWAYS 1
    CMAKE_ARGS
      -DCMAKE_INSTALL_PREFIX:PATH=${INSTALL_DIR}/${target}
      -DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}
      -DCMAKE_TOOLCHAIN_FILE:PATH=${_ARM_TOOLCHAIN}
      -DVTKCompileTools_DIR:PATH=${CMAKE_BINARY_DIR}/CompileTools
      -DCMAKE_MAKE_PROGRAM:FILEPATH=${CMAKE_MAKE_PROGRAM}
      ${arm_cmake_flags}
  )
  set(${out_build_dir} "${BUILD_DIR}/${_ARM_DIR}")
endmacro()
crosscompile(vtk-arm vtk_arm_build_dir)
