...
vtkCxxSetObjectMacro(vtkImageProbeFilter, CellLocatorPrototype, vtkAbstractCellLocator);
vtkCxxSetObjectMacro(vtkImageProbeFilter, FindCellStrategy, vtkFindCellStrategy);
...
//----------------------------------------------------------------------------
void vtkImageProbeFilter::Probe(vtkDataSet* input, vtkDataSet* source, vtkDataSet* output)
{
...
//---------------------------------------------------------------------------
void vtkImageProbeFilter::ProbeImagePointsInCell(vtkCell* cell, vtkIdType cellId,
...
class vtkImageProbeFilter::ProbeImageDataWorklet
{
public:
  ProbeImageDataWorklet(vtkImageProbeFilter* probeFilter, vtkDataSet* source, int srcBlockId,
...
//----------------------------------------------------------------------------
void vtkImageProbeFilter::ProbePointsImageData(
