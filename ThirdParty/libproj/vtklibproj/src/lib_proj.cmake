...
if (FALSE) # XXX(kitware): VTK already provides this
...
vtk_module_compile_options(VTK::libproj
  PRIVATE $<$<COMPILE_LANGUAGE:C>:${PROJ_C_WARN_FLAGS}>
  PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${PROJ_CXX_WARN_FLAGS}>
)
...
vtk_module_set_properties(VTK::libproj
  LINKER_LANGUAGE CXX)
endif ()
...
if (FALSE) # use VTK modules
  ...
  vtk_module_definitions(VTK::libproj PRIVATE -DTIFF_ENABLED)
  vtk_module_include(VTK::libproj PRIVATE ${TIFF_INCLUDE_DIR})
  vtk_module_link(VTK::libproj PRIVATE ${TIFF_LIBRARY})
endif ()
endif()
...
if (FALSE) # XXX(kitware): VTK does this
