...
//------------------------------------------------------------------------------
void vtkAMREnzoParticlesReader::PrintSelf(std::ostream& os, vtkIndent indent)
{
...
vtkPolyData* vtkAMREnzoParticlesReader::GetParticles(const char* file, const int blockIdx)
{
  ...
  vtkIntArray* particleTypes = vtkArrayDownCast<vtkIntArray>(this->GetParticlesTypeArray(blockIdx));
...
void vtkAMREnzoParticlesReader::SetupParticleDataSelections()
{
  ...
  {
    bool isParticleAttribute = vtksys::SystemTools::StringStartsWith(
