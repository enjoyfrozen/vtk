...
int TestCesium3DTilesWriter(int argc, char* argv[])
{
  ...
  {
    std::cerr << "Cannot open: " << dataRoot
              << "/Data/3DTiles/jacksonville-tileset.json" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  if (testFile.fail())
  {
    std::cerr << "Cannot open: " << tempDirectory
              << "/jacksonville-3dtiles/tileset.json"<< std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Cannot open: " << dataRoot
              << "/Data/3DTiles/berlin-tileset.json" << std::endl;
    return EXIT_FAILURE;
  }
  ...
  {
    std::cerr << "Cannot open: " << tempDirectory
              << "/berlin-3dtiles/tileset.json"<< std::endl;
    return EXIT_FAILURE;
  }
