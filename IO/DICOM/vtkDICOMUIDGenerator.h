 ...
 *  chars or longer.
 */
class VTKIODICOM_EXPORT vtkDICOMUIDGenerator : public vtkObject
{
public:
  ...
  static vtkDICOMUIDGenerator* GetDefault() { return vtkDICOMUIDGenerator::Default; }
  //@}
 ...
 */
class VTKIODICOM_EXPORT vtkDICOMUIDGeneratorInitializer
{
public:
...
private:
  vtkDICOMUIDGeneratorInitializer(const vtkDICOMUIDGeneratorInitializer&) = delete;
