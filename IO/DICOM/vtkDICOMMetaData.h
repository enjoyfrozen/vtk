 ...
 */
class VTKIODICOM_EXPORT vtkDICOMMetaData : public vtkDataObject
{
public:
  ...
  int GetNumberOfDataElements() { return this->NumberOfDataElements; }

  //! Get an iterator for the list of data elements.
  vtkDICOMDataElementIterator Begin() { return this->Head.Next; }

  //! Get an end iterator for the list of data elements.
  vtkDICOMDataElementIterator End() { return &this->Tail; }
  //@}
  ...
  bool HasAttribute(vtkDICOMTag tag) { return this->Has(tag); }

  //! Erase an attribute.
  void Erase(vtkDICOMTag tag);
  void RemoveAttribute(vtkDICOMTag tag) { this->Erase(tag); }
  //@}
  ...
  const vtkDICOMValue& GetAttributeValue(vtkDICOMTag tag) { return this->Get(tag); }
  const vtkDICOMValue& GetAttributeValue(const vtkDICOMTagPath& p) { return this->Get(p); }
  //@}
  ...
  const vtkDICOMValue& GetAttributeValue(int idx, vtkDICOMTag tag) { return this->Get(idx, tag); }
  ...
  const vtkDICOMValue& GetAttributeValue(int idx, int frame, const vtkDICOMTagPath& p)
  {
  ...
  void SetAttributeValue(int idx, vtkDICOMTag tag, double v) { this->Set(idx, tag, v); }
  void SetAttributeValue(int idx, vtkDICOMTag tag, const std::string& v) { this->Set(idx, tag, v); }
  //@}
  ...
  void SetAttributeValue(vtkDICOMTag tag, const vtkDICOMValue& v) { this->Set(tag, v); }
  void SetAttributeValue(vtkDICOMTag tag, double v) { this->Set(tag, v); }
  void SetAttributeValue(vtkDICOMTag tag, const std::string& v) { this->Set(tag, v); }
  //@}
  ...
  void SetAttributeValue(int idx, const vtkDICOMTagPath& tag, const vtkDICOMValue& v)
  {
    this->Set(idx, tag, v);
  }
  void SetAttributeValue(int idx, const vtkDICOMTagPath& tag, double v) { this->Set(idx, tag, v); }
  void SetAttributeValue(int idx, const vtkDICOMTagPath& tag, const std::string& v)
  {
    this->Set(idx, tag, v);
  }
  //@}
  ...
  void SetAttributeValue(const vtkDICOMTagPath& tag, const vtkDICOMValue& v) { this->Set(tag, v); }
  void SetAttributeValue(const vtkDICOMTagPath& tag, double v) { this->Set(tag, v); }
  void SetAttributeValue(const vtkDICOMTagPath& tag, const std::string& v) { this->Set(tag, v); }
  //@}
...
protected:
  ...
  int FindItemsOrInsert(
    int idx, bool useidx, const vtkDICOMTagPath& tagpath, vtkDICOMItem* items[]);
