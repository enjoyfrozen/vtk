...
vtkDICOMDictionary::DictHashEntry* vtkDICOMDictionary::PrivateDictTable[DICT_PRIVATE_TABLE_SIZE];
...
//----------------------------------------------------------------------------
unsigned int vtkDICOMDictionary::HashLongString(const char* input, char output[64])
{
...
//----------------------------------------------------------------------------
vtkDICOMDictionary::Dict* vtkDICOMDictionary::FindPrivateDict(const char* name)
{
...
//----------------------------------------------------------------------------
vtkDICOMDictEntry vtkDICOMDictionary::FindDictEntry(const vtkDICOMTag tag, const char* dictname)
{
...
//----------------------------------------------------------------------------
vtkDICOMDictEntry vtkDICOMDictionary::FindDictEntry(const char* key, const char* dictname)
{
  if (key == 0 || key[0] == '\0')
  {
    return vtkDICOMDictEntry();
