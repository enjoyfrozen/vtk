...
//----------------------------------------------------------------------------
class VTKIODICOM_EXPORT vtkDICOMCTRectifier : public vtkDICOMAlgorithm
{
public:
  ...
  void SetInterpolationModeToNearest() { this->SetInterpolationMode(Nearest); }
  void SetInterpolationModeToLinear() { this->SetInterpolationMode(Linear); }
  void SetInterpolationModeToCubic() { this->SetInterpolationMode(Cubic); }
  void SetInterpolationModeToWindowedSinc() { this->SetInterpolationMode(WindowedSinc); }
...
protected:
   ...
   */
  void ComputeMatrix(
    const double matrix[16], const int extent[6], double spacing[3], double origin[3]);
