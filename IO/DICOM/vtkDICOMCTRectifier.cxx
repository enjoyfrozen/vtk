...
void vtkDICOMCTRectifier::ComputeMatrix(
  const double volumeMatrix[16], const int extent[6], double spacing[3], double origin[3])
{
  if (volumeMatrix == 0)
  {
...
//----------------------------------------------------------------------------
int vtkDICOMCTRectifier::RequestUpdateExtent(vtkInformation* vtkNotUsed(request),
...
//----------------------------------------------------------------------------
int vtkDICOMCTRectifier::RequestData(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  vtkInformation* inInfo = inputVector[0]->GetInformationObject(0);
...
//----------------------------------------------------------------------------
void vtkDICOMCTRectifier::ThreadedRequestData(vtkInformation*, vtkInformationVector**,
