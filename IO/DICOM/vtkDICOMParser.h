 ...
 *  with GetFileOffset().
 */
class VTKIODICOM_EXPORT vtkDICOMParser : public vtkObject
{
public:
  ...
  void OverrideCharacterSetOn() { this->SetOverrideCharacterSet(true); }
  void OverrideCharacterSetOff() { this->SetOverrideCharacterSet(false); }
...
protected:
  ...
  bool ReadMetaHeader(
    const unsigned char*& cp, const unsigned char*& ep, vtkDICOMMetaData* data, int idx);
