...
extern template void vtkDICOMValue::AppendInit<vtkDICOMItem>(vtkDICOMVR);

extern template void vtkDICOMValue::AppendValue<vtkDICOMItem>(const vtkDICOMItem&);

extern template void vtkDICOMValue::SetValue<vtkDICOMItem>(size_t, const vtkDICOMItem&);
#endif
...
//----------------------------------------------------------------------------
const vtkDICOMValue& vtkDICOMSequence::Get(size_t i, const vtkDICOMTagPath& tagpath) const
{
  const vtkDICOMItem* ptr = this->V.GetSequenceData();
  if (ptr != 0 && i < this->V.GetNumberOfValues())
  {
