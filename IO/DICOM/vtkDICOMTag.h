...
class VTKIODICOM_EXPORT vtkDICOMTag
{
public:
  ...
  unsigned short GetGroup() const { return static_cast<unsigned short>(this->Key >> 16); }

  //! Get the 16-bit element identifier.
  unsigned short GetElement() const { return static_cast<unsigned short>(this->Key); }
  //@}
  ...
  //@{
  bool operator==(const vtkDICOMTag& b) const { return (this->Key == b.Key); }
...
VTKIODICOM_EXPORT ostream& operator<<(ostream& o, const vtkDICOMTag& a);
