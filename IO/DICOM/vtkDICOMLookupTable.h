...
//----------------------------------------------------------------------------
class VTKIODICOM_EXPORT vtkDICOMLookupTable : public vtkLookupTable
{
public:
...
protected:
   ...
   */
  static bool BuildSegmentedLUT(const unsigned short* input, unsigned int n, double divisor,
