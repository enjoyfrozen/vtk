...
//----------------------------------------------------------------------------
class VTKIODICOM_EXPORT vtkDICOMReader : public vtkImageReader2
{
public:
  ...
  const char* GetFileExtensions() override { return ".dcm .dc"; }
  ...
  vtkDICOMCharacterSet GetDefaultCharacterSet() { return this->DefaultCharacterSet; }
  ...
  bool GetOverrideCharacterSet() { return this->OverrideCharacterSet; }
  //@}
  ...
  void SetMemoryRowOrderToFileNative() { this->SetMemoryRowOrder(FileNative); }
  void SetMemoryRowOrderToTopDown() { this->SetMemoryRowOrder(TopDown); }
  void SetMemoryRowOrderToBottomUp() { this->SetMemoryRowOrder(BottomUp); }
...
protected:
  ...
  virtual bool ReadOneFile(
    const char* filename, int idx, unsigned char* buffer, vtkIdType bufferSize);
  ...
  virtual void RescaleBuffer(int fileIdx, int frameIdx, int fileType, int outputType,
    int numFileComponents, int numComponents, void* fileBuffer, void* outputBuffer,
