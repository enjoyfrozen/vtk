...
class VTKIODICOM_EXPORT vtkDICOMVM
{
public:
  enum EnumType
  {
  ...
  vtkDICOMVM(EnumType vm)
    : Key(static_cast<unsigned short>(vm))
  {
  }
  //@}
...
VTKIODICOM_EXPORT ostream& operator<<(ostream& o, const vtkDICOMVM& a);
