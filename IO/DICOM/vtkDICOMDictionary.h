...
class VTKIODICOM_EXPORT vtkDICOMDictionary
{
public:
 ...
 */
class VTKIODICOM_EXPORT vtkDICOMDictionaryInitializer
{
public:
...
private:
  ...
  vtkDICOMDictionaryInitializer& operator=(const vtkDICOMDictionaryInitializer&);
};
