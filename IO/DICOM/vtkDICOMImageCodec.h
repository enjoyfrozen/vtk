 ...
 */
class VTKIODICOM_EXPORT vtkDICOMImageCodec
{
public:
  enum EnumType
  {
   ...
   */
  int Decode(const ImageFormat& image, const unsigned char* source, size_t sourceSize,
   ...
   *  destination buffer.
   */
  int Encode(const ImageFormat& image, const unsigned char* source, size_t sourceSize,
    unsigned char** dest, size_t* destSize) const;
  //@}
...
private:
  ...
  static int DecodeRLE(const ImageFormat& image, const unsigned char* source, size_t sourceSize,
    unsigned char* dest, size_t destSize);

  static int EncodeRLE(const ImageFormat& image, const unsigned char* source, size_t sourceSize,
    unsigned char** dest, size_t* destSize);
...
VTKIODICOM_EXPORT ostream& operator<<(ostream& o, const vtkDICOMImageCodec& a);
