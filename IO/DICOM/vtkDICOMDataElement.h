 ...
 */
class VTKIODICOM_EXPORT vtkDICOMDataElement
{
public:
  //@{
  vtkDICOMDataElement()
  ...
  int GetNumberOfInstances() const { return static_cast<int>(this->Value.GetNumberOfValues()); }
...
class VTKIODICOM_EXPORT vtkDICOMDataElementIterator
{
public:
  //@{
  vtkDICOMDataElementIterator()
    : Pointer(0)
  {
  }
  //@}
...
private:
  vtkDICOMDataElementIterator(const vtkDICOMDataElement* ptr) { this->Pointer = ptr; }
...
VTKIODICOM_EXPORT ostream& operator<<(ostream& os, const vtkDICOMDataElement& v);
