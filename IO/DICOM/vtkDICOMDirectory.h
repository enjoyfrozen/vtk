 ...
 *  and image.
 */
class VTKIODICOM_EXPORT vtkDICOMDirectory : public vtkAlgorithm
{
public:
   ...
   */
  void Update() override { this->Update(0); }
...
protected:
  ...
  void AddSeriesWithQuery(int patient, int study, vtkStringArray* files,
    const vtkDICOMItem& patientRecord, const vtkDICOMItem& studyRecord,
    const vtkDICOMItem& seriesRecord, const vtkDICOMItem* imageRecords[]);
  ...
  //! Set the error code.
  void SetErrorCode(unsigned long e) override { this->ErrorCode = e; }
