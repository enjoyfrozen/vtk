 ...
 */
class VTKIODICOM_EXPORT vtkDICOMSequence
{
public:
  //@{
  ...
  const vtkDICOMValue& GetAttributeValue(size_t i, vtkDICOMTag tag) const
  {
    return this->Get(i, tag);
  }
  const vtkDICOMValue& GetAttributeValue(size_t i, const vtkDICOMTagPath& p) const
  {
    return this->Get(i, p);
  }
  //@}
  ...
  size_t GetNumberOfItems() const { return this->V.GetNumberOfValues(); }
  //@}
  ...
  const vtkDICOMItem* GetSequenceData() const { return this->V.GetSequenceData(); }
  //@}
  ...
  bool IsValid() const { return this->V.IsValid(); }
  //@}
...
VTKIODICOM_EXPORT ostream& operator<<(ostream& os, const vtkDICOMSequence& v);
