...
{
public:
  OutputString(char* cp, size_t l) { setp(cp, cp + l); }
...
template <class OT>
void StringConversion(const char* cp, vtkDICOMVR vr, OT* v, size_t i, size_t n)
{
...
T* vtkDICOMValue::Allocate(vtkDICOMVR vr, size_t vn)
{
  ...
  assert(static_cast<char*>(static_cast<void*>(v->Data)) == static_cast<char*>(vp) + sizeof(Value));
  this->V = v;
  return v->Data;
}
...
char* vtkDICOMValue::AllocateCharData(vtkDICOMVR vr, vtkDICOMCharacterSet cs, size_t vn)
{
...
unsigned char* vtkDICOMValue::AllocateUnsignedCharData(vtkDICOMVR vr, size_t vn)
{
...
unsigned short* vtkDICOMValue::AllocateUnsignedShortData(vtkDICOMVR vr, size_t vn)
{
...
unsigned int* vtkDICOMValue::AllocateUnsignedIntData(vtkDICOMVR vr, size_t vn)
{
...
unsigned long long* vtkDICOMValue::AllocateUnsignedInt64Data(vtkDICOMVR vr, size_t vn)
{
...
vtkDICOMTag* vtkDICOMValue::AllocateTagData(vtkDICOMVR vr, size_t vn)
{
  return this->Allocate<vtkDICOMTag>(vr, vn);
}

vtkDICOMItem* vtkDICOMValue::AllocateSequenceData(vtkDICOMVR vr, size_t vn)
{
  return this->Allocate<vtkDICOMItem>(vr, vn);
}

vtkDICOMValue* vtkDICOMValue::AllocateMultiplexData(vtkDICOMVR vr, size_t vn)
{
...
unsigned char* vtkDICOMValue::ReallocateUnsignedCharData(size_t vn)
{
  ...
  unsigned char* ptr = static_cast<ValueT<unsigned char>*>(this->V)->Data;
...
void vtkDICOMValue::CreateValue(vtkDICOMVR vr, const T* data, size_t n)
{
  ...
  else if (vr == VR::DS)
  {
    ...
    for (size_t i = 0; i < n; i++)
    {
      ...
      if (dl >= 5 && (cp[dl - 5] == 'e' || cp[dl - 5] == 'E') && cp[dl - 3] == '0' &&
        cp[dl - 2] >= '0' && cp[dl - 2] <= '9' && cp[dl - 1] >= '0' && cp[dl - 1] <= '9')
      {
        cp[dl - 3] = cp[dl - 2];
        cp[dl - 2] = cp[dl - 1];
        sb.adjust(-1);
  ...
  else if (vr == VR::OV)
  {
    ...
    {
      unsigned long long* ptr = this->AllocateUnsignedInt64Data(vr, n * sizeof(T) / 4);
      memcpy(ptr, data, n * sizeof(T));
    }
  }
  else if (vr == VR::OF)
...
template <>
void vtkDICOMValue::CreateValue<vtkDICOMTag>(vtkDICOMVR vr, const vtkDICOMTag* data, size_t n)
{
  typedef vtkDICOMVR VR; // shorthand
...
template <>
void vtkDICOMValue::CreateValue<vtkDICOMItem>(vtkDICOMVR vr, const vtkDICOMItem* data, size_t n)
{
  typedef vtkDICOMVR VR; // shorthand
...
template <>
void vtkDICOMValue::CreateValue<char>(vtkDICOMVR vr, const char* data, size_t m)
{
...
vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const char* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const unsigned char* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const short* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const unsigned short* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const int* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const unsigned int* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const long long* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const unsigned long long* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const float* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const double* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const vtkDICOMTag* data, size_t count)
{
  this->CreateValue(vr, data, count);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, const vtkDICOMItem* data, size_t count)
{
  this->CreateValue(vr, data, count);
}
...
vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, vtkDICOMCharacterSet cs, const char* data, size_t l)
{
  this->CreateValueWithSpecificCharacterSet(vr, cs, data, l);
}

vtkDICOMValue::vtkDICOMValue(vtkDICOMVR vr, vtkDICOMCharacterSet cs, const std::string& v)
{
...
template void vtkDICOMValue::AppendValue<vtkDICOMItem>(const vtkDICOMItem& item);
...
template void vtkDICOMValue::SetValue<vtkDICOMItem>(size_t i, const vtkDICOMItem& item);
...
const short* vtkDICOMValue::GetShortData() const
{
  ...
  if (this->V)
  {
    ...
    else if (this->V->Type == VTK_UNSIGNED_SHORT && this->V->VR == vtkDICOMVR::OW)
    {
      ptr =
        reinterpret_cast<const short*>(static_cast<const ValueT<unsigned short>*>(this->V)->Data);
    }
  }
  return ptr;
}
...
const unsigned short* vtkDICOMValue::GetUnsignedShortData() const
{
  ...
  if (this->V)
  {
    ...
    else if (this->V->Type == VTK_SHORT && this->V->VR == vtkDICOMVR::OW)
    {
      ptr =
        reinterpret_cast<const unsigned short*>(static_cast<const ValueT<short>*>(this->V)->Data);
    }
  }
  return ptr;
}
...
const int* vtkDICOMValue::GetIntData() const
{
  ...
  if (this->V)
  {
    ...
    else if (this->V->Type == VTK_UNSIGNED_INT && this->V->VR == vtkDICOMVR::OL)
    {
      ptr = reinterpret_cast<const int*>(static_cast<const ValueT<unsigned int>*>(this->V)->Data);
    }
  }
  return ptr;
}
...
const unsigned int* vtkDICOMValue::GetUnsignedIntData() const
{
  ...
  if (this->V)
  {
    ...
    else if (this->V->Type == VTK_INT && this->V->VR == vtkDICOMVR::OL)
    {
      ptr = reinterpret_cast<const unsigned int*>(static_cast<const ValueT<int>*>(this->V)->Data);
    }
  }
  return ptr;
}
...
const long long* vtkDICOMValue::GetInt64Data() const
{
  ...
  if (this->V)
  {
    ...
    else if (this->V->Type == VTK_UNSIGNED_LONG_LONG && this->V->VR == vtkDICOMVR::OV)
    {
...
const unsigned long long* vtkDICOMValue::GetUnsignedInt64Data() const
{
  ...
  if (this->V)
  {
    ...
    else if (this->V->Type == VTK_LONG_LONG && this->V->VR == vtkDICOMVR::OV)
    {
...
void vtkDICOMValue::GetValuesT(VT* v, size_t c, size_t s) const
{
  ...
  {
    case VTK_CHAR:
      StringConversion(static_cast<const ValueT<char>*>(this->V)->Data, this->V->VR, v, s, c);
      break;
    case VTK_UNSIGNED_CHAR:
      NumericalConversion(static_cast<const ValueT<unsigned char>*>(this->V)->Data + s, v, c);
      break;
    case VTK_SHORT:
      NumericalConversion(static_cast<const ValueT<short>*>(this->V)->Data + s, v, c);
      break;
    case VTK_UNSIGNED_SHORT:
      NumericalConversion(static_cast<const ValueT<unsigned short>*>(this->V)->Data + s, v, c);
      break;
    case VTK_INT:
      NumericalConversion(static_cast<const ValueT<int>*>(this->V)->Data + s, v, c);
      break;
    case VTK_UNSIGNED_INT:
      NumericalConversion(static_cast<const ValueT<unsigned int>*>(this->V)->Data + s, v, c);
      break;
    case VTK_LONG_LONG:
      NumericalConversion(static_cast<const ValueT<long long>*>(this->V)->Data + s, v, c);
      break;
    case VTK_UNSIGNED_LONG_LONG:
      NumericalConversion(static_cast<const ValueT<unsigned long long>*>(this->V)->Data + s, v, c);
      break;
    case VTK_FLOAT:
      NumericalConversion(static_cast<const ValueT<float>*>(this->V)->Data + s, v, c);
      break;
    case VTK_DOUBLE:
      NumericalConversion(static_cast<const ValueT<double>*>(this->V)->Data + s, v, c);
      break;
    case VTK_DICOM_TAG:
    {
      const vtkDICOMTag* tptr = static_cast<const ValueT<vtkDICOMTag>*>(this->V)->Data + s;
...
template <>
void vtkDICOMValue::GetValuesT<std::string>(std::string* v, size_t c, size_t s) const
{
...
template <>
void vtkDICOMValue::GetValuesT<vtkDICOMTag>(vtkDICOMTag* v, size_t c, size_t s) const
{
  if (this->V->Type == VTK_DICOM_TAG)
  {
    const vtkDICOMTag* ptr = static_cast<const ValueT<vtkDICOMTag>*>(this->V)->Data + s;
    for (size_t i = 0; i < c; i++)
    {
      *v++ = *ptr++;
    }
...
{
  vtkDICOMTag v;
  if (this->V && this->V->VR == vtkDICOMVR::AT && i < this->V->NumberOfValues)
  {
    this->GetValuesT(&v, 1, i);
  }
  return v;
...
{
  if (this->V && this->V->Type == VTK_DICOM_ITEM && i < this->V->NumberOfValues)
  {
    const vtkDICOMItem* ptr = static_cast<const ValueT<vtkDICOMItem>*>(this->V)->Data;
    return ptr[i];
  }
...
std::string vtkDICOMValue::AsString() const
{
  ...
  std::string v;
  if (this->V && this->V->VR != vtkDICOMVR::UN && this->V->VR != vtkDICOMVR::SQ &&
    this->V->VR != vtkDICOMVR::OW && this->V->VR != vtkDICOMVR::OB &&
    this->V->VR != vtkDICOMVR::OL && this->V->VR != vtkDICOMVR::OV &&
    this->V->VR != vtkDICOMVR::OF && this->V->VR != vtkDICOMVR::OD)
  {
    size_t n = this->V->NumberOfValues;
    for (size_t i = 0; i < n; i++)
    {
...
{
  vtkDICOMTag v;
  if (this->V && this->V->VR == vtkDICOMVR::AT && this->V->NumberOfValues >= 1)
  {
    this->GetValuesT(&v, 1, 0);
  }
  return v;
...
void vtkDICOMValue::Substring(size_t i, const char*& start, const char*& end) const
{
...
//----------------------------------------------------------------------------
void vtkDICOMValue::AppendValueToSafeUTF8String(std::string& str, size_t i) const
{
  if (this->V && this->V->Type == VTK_CHAR)
  {
    const char* cp = static_cast<const ValueT<char>*>(this->V)->Data;
...
//----------------------------------------------------------------------------
void vtkDICOMValue::AppendValueToUTF8String(std::string& str, size_t i) const
{
  if (this->V && this->V->Type == VTK_CHAR && this->V->CharacterSet != 0)
  {
    const char* cp = static_cast<const ValueT<char>*>(this->V)->Data;
    size_t l = this->V->VL;
    if (this->V->VR.HasSingleValue())
...
void vtkDICOMValue::AppendValueToString(std::string& str, size_t i) const
{
  const char* cp = 0;
  const char* dp = 0;
  double f = 0.0;
  ...
  else if (this->V->Type == VTK_FLOAT || this->V->Type == VTK_DOUBLE)
  {
    ...
    else
    {
      ...
      if ((this->V->Type == VTK_DOUBLE && fabs(f) <= 9007199254740992.0) || // 2^53
        (this->V->Type == VTK_FLOAT && fabs(f) <= 16777216.0))              // 2^24
      {
      ...
      size_t ti = 0;
      while (ti < l && text[ti] != 'e')
      {
        ti++;
      }
      size_t tj = ti;
      while (tj > 1 && text[tj - 1] == '0' && text[tj - 2] != '.')
      {
        tj--;
      }
      ...
      if (ti < l && text[ti] == 'e')
      {
        if (tj > 2 && text[tj - 1] == '0' && text[tj - 2] == '.')
        {
          tj -= 2;
        }
        else if (tj > 1 && text[tj - 1] == '.')
        {
          tj -= 1;
        }
      }
  ...
  else if (this->V->Type == VTK_UNSIGNED_CHAR || this->V->Type == VTK_SHORT ||
    this->V->Type == VTK_UNSIGNED_SHORT || this->V->Type == VTK_INT ||
    this->V->Type == VTK_UNSIGNED_INT || this->V->Type == VTK_LONG_LONG ||
...
template <>
bool vtkDICOMValue::ValueT<char>::Compare(const Value* a, const Value* b)
{
  bool r = (a->VL == b->VL);
  ...
  if (n != 0 && r)
  {
    const unsigned char* ap = static_cast<const ValueT<unsigned char>*>(a)->Data;
    const unsigned char* bp = static_cast<const ValueT<unsigned char>*>(b)->Data;
    do
    {
      r &= (*ap++ == *bp++);
    } while (r && --n);
...
template <>
bool vtkDICOMValue::ValueT<unsigned char>::Compare(const Value* a, const Value* b)
{
  bool r = (a->VL == b->VL);
  size_t n = a->VL;
  if (a->VL == 0xFFFFFFFF)
...
template <>
bool vtkDICOMValue::ValueT<vtkDICOMItem>::Compare(const Value* a, const Value* b)
{
  size_t n = a->NumberOfValues; // do not use VL/sizeof()
  bool r = (n == b->NumberOfValues);
  if (n != 0 && r)
  {
    const vtkDICOMItem* ap = static_cast<const ValueT<vtkDICOMItem>*>(a)->Data;
    const vtkDICOMItem* bp = static_cast<const ValueT<vtkDICOMItem>*>(b)->Data;
    do
    {
      r &= (*ap++ == *bp++);
    } while (r && --n);
...
template <>
bool vtkDICOMValue::ValueT<vtkDICOMValue>::Compare(const Value* a, const Value* b)
{
  size_t n = a->NumberOfValues; // do not use VL/sizeof()
  bool r = (n == b->NumberOfValues);
  if (n != 0 && r)
  {
    const vtkDICOMValue* ap = static_cast<const ValueT<vtkDICOMValue>*>(a)->Data;
    const vtkDICOMValue* bp = static_cast<const ValueT<vtkDICOMValue>*>(b)->Data;
    do
    {
      r &= (*ap++ == *bp++);
    } while (r && --n);
...
//----------------------------------------------------------------------------
bool vtkDICOMValue::PatternMatchesMulti(const char* pattern, const char* val, vtkDICOMVR vr)
{
  typedef vtkDICOMVR VR;
  bool inclusive = (vr == VR::UI);
  bool ordered = (vr == VR::IS || vr == VR::DS);
  bool nowildcards = (vr == VR::UI || vr == VR::AS || vr == VR::IS || vr == VR::DS);
...
//----------------------------------------------------------------------------
bool vtkDICOMValue::PatternMatchesPersonName(const char* pattern, const char* val)
{
  bool match = false;
  ...
  while (!match)
  {
    ...
    while (!match)
    {
      ...
      match = vtkDICOMUtilities::PatternMatches(
        normalizedPattern, strlen(normalizedPattern), normalizedName, strlen(normalizedName));
...
//----------------------------------------------------------------------------
void vtkDICOMValue::NormalizePersonName(const char* input, char output[256], bool isquery)
{
  ...
  for (int i = 0; i < 3; i++)
  {
    ...
    for (int j = 0; j < 5; j++)
    {
      ...
      else if (isquery && dp != componentStart)
      {
        ...
        {
          --dp;
        } while (dp != componentStart && (*dp & 0xC0) == 0x80);
        *dp++ = '*';
      }
    ...
    if (isquery)
    {
      while (dp - groupStart > 2 && dp[-3] == '*' && dp[-2] == '^' && dp[-1] == '*')
      {
        dp -= 2;
      }
    }
  ...
  if (isquery)
  {
    while (dp - output > 2 && dp[-3] == '*' && dp[-2] == '=' && dp[-1] == '*')
    {
      dp -= 2;
    }
  }
...
//----------------------------------------------------------------------------
size_t vtkDICOMValue::NormalizeDateTime(const char* input, char output[22], vtkDICOMVR vr)
{
...
bool vtkDICOMValue::Matches(const vtkDICOMValue& value) const
{
  ...
  */
  ...
  if (value.V->Type != VTK_DICOM_ITEM)
  {
    ...
    static_cast<const ValueT<vtkDICOMItem>*>(value.V)->Data->GetNumberOfDataElements() == 0)
  {
  ...
  if (type == VTK_CHAR)
  {
    ...
    if (!wildcard && (vr == vtkDICOMVR::DA || vr == vtkDICOMVR::TM || vr == vtkDICOMVR::DT))
    {
      // Find the position of the hyphen
      size_t hp = 0;
      while (hp < pl && pattern[hp] != '-')
      {
        hp++;
      }
...
bool vtkDICOMValue::Matches(const std::string& value) const
{
  ...
  if (this->V)
  {
    ...
    {
      return this->Matches(vtkDICOMValue(this->V->VR, this->V->CharacterSet, value));
    }
    else
    {
...
ostream& operator<<(ostream& os, const vtkDICOMValue& v)
{
  ...
  else if (vr == vtkDICOMVR::ST || vr == vtkDICOMVR::LT || vr == vtkDICOMVR::UT)
  {
