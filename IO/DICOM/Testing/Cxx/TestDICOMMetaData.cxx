...
int TestDICOMMetaData(int argc, char* argv[])
{
  ...
  vtkDICOMDataElementIterator iter = metaData->Begin();
  vtkDICOMDataElementIterator iterEnd = metaData->End();
  ...
  const char* instanceUIDFormat = "1.2.840.113619.2.176.2025.4110284.7408.1276101323.%i";
  char instanceUID[54];
  ...
  for (int i = 0; i < 1; i++)
  {
    ...
    item.Set(DC::SeriesInstanceUID,
      vtkDICOMValue(vtkDICOMVR::UI, "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239"));
    ...
    for (int j = 0; j < 10; j++)
    {
      ...
      item2.Set(DC::ReferencedSOPClassUID, vtkDICOMValue(vtkDICOMVR::UI, classUID));
      item2.Set(DC::ReferencedSOPInstanceUID, vtkDICOMValue(vtkDICOMVR::UI, instanceUID));
      seq2.AddItem(item2);
    }
  ...
  vtkDICOMValue v2 =
    metaData->Get(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
  TestAssert(v2.GetCharData() != 0);
  if (v2.GetCharData())
  {
    TestAssert(
      strcmp(v2.GetCharData(), "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239") == 0);
  }

  // test access two levels deep
  v2 = metaData->Get(vtkDICOMTagPath(
    DC::ReferencedSeriesSequence, 0, DC::ReferencedInstanceSequence, 0, DC::ReferencedSOPClassUID));
  TestAssert(v2.GetCharData() != 0);
  if (v2.GetCharData())
  {
  ...
  metaData->Set(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID),
    vtkDICOMValue(vtkDICOMVR::UI, "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239"));
  ...
  for (int j = 0; j < 10; j++)
  {
    // create a unique InstanceUID
    sprintf(instanceUID, instanceUIDFormat, 255 + j);
    metaData->Set(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::ReferencedInstanceSequence,
                    j, DC::ReferencedSOPClassUID),
      classUID);
    metaData->Set(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::ReferencedInstanceSequence,
                    j, DC::ReferencedSOPInstanceUID),
      instanceUID);
  }

  // test nested access with tag path
  v2 = metaData->Get(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
  TestAssert(v2.GetCharData() != 0);
  if (v2.GetCharData())
  {
    TestAssert(
  ...
  // test access two levels deep
  v2 = metaData->Get(vtkDICOMTagPath(
    DC::ReferencedSeriesSequence, 0, DC::ReferencedInstanceSequence, 9, DC::ReferencedSOPClassUID));
  TestAssert(v2.GetCharData() != 0);
  if (v2.GetCharData())
  {
    TestAssert(strcmp(v2.GetCharData(), "1.2.840.10008.5.1.4.1.1.4") == 0);
  }
  v2 = metaData->Get(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0,
    DC::ReferencedInstanceSequence, 8, DC::ReferencedSOPInstanceUID));
  TestAssert(v2.GetCharData() != 0);
  if (v2.GetCharData())
  {
    TestAssert(
      0 == strcmp(v2.GetCharData(), "1.2.840.113619.2.176.2025.4110284.7408.1276101323.263"));
  }
  ...
  metaData->Set(
    vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::RealWorldValueLastValueMapped), 4095);
  v2 = metaData->Get(
    vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::RealWorldValueLastValueMapped));
  TestAssert(v2.GetVR() == vtkDICOMVR::US);

  // next, check default CharacterSet=ISO_IR_6
  metaData->Set(
    vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::LUTExplanation), "Too Hot");
  v2 = metaData->Get(vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::LUTExplanation));
  ...
  // two levels deep
  metaData->Set(vtkDICOMTagPath(DC::IconImageSequence, 0, DC::RealWorldValueMappingSequence, 0,
                  DC::RealWorldValueLastValueMapped),
    4095);
  v2 = metaData->Get(vtkDICOMTagPath(DC::IconImageSequence, 0, DC::RealWorldValueMappingSequence, 0,
    DC::RealWorldValueLastValueMapped));
  TestAssert(v2.GetVR() == vtkDICOMVR::SS);
  ...
  metaData->Set(vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::SpecificCharacterSet),
    "\\ISO 2022 IR 149");
  metaData->Set(
    vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::LUTExplanation), "Too Hot");
  v2 = metaData->Get(vtkDICOMTagPath(DC::RealWorldValueMappingSequence, 0, DC::LUTExplanation));
  ...
  metaData->Set(vtkDICOMTagPath(DC::IconImageSequence, 0, DC::RealWorldValueMappingSequence, 0,
    ...
    "Too Hot");
  v2 = metaData->Get(vtkDICOMTagPath(
    DC::IconImageSequence, 0, DC::RealWorldValueMappingSequence, 0, DC::LUTExplanation));
  TestAssert(v2.GetCharacterSet() == vtkDICOMCharacterSet::ISO_IR_100);
  ...
  metaData->Set(vtkDICOMTagPath(DC::SeriesInstanceUID, 0, DC::SeriesInstanceUID),
    vtkDICOMValue(vtkDICOMVR::UI, "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239"));
  TestAssert(metaData->GetNumberOfDataElements() == 0);

  // ------
  // test using a non-sequence that already exists
  metaData->Set(DC::SeriesInstanceUID, "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239");
  metaData->Set(vtkDICOMTagPath(DC::SeriesInstanceUID, 0, DC::SeriesInstanceUID),
    vtkDICOMValue(vtkDICOMVR::UI, "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239"));
  v2 = metaData->Get(vtkDICOMTagPath(DC::SeriesInstanceUID, 0, DC::SeriesInstanceUID));
  ...
  metaData->Set(vtkDICOMTagPath(vtkDICOMTag(0x0009, 0x1013), 0, vtkDICOMTag(0x0009, 0x1014), 1,
                  vtkDICOMTag(0x0009, 0x1015)),
    vtkDICOMValue(vtkDICOMVR::UI, "1.2.840.113619.2.176.2025"));
  v2 = metaData->Get(vtkDICOMTagPath(
    vtkDICOMTag(0x0009, 0x1013), 0, vtkDICOMTag(0x0009, 0x1014), 1, vtkDICOMTag(0x0009, 0x1015)));
  TestAssert(v2.AsString() == "1.2.840.113619.2.176.2025");
  // make sure the "skipped" item returns nothing
  v2 = metaData->Get(vtkDICOMTagPath(
    vtkDICOMTag(0x0009, 0x1013), 0, vtkDICOMTag(0x0009, 0x1014), 0, vtkDICOMTag(0x0009, 0x1015)));
  TestAssert(!v2.IsValid());
  ...
  metaData->SetNumberOfInstances(3);
  metaData->Set(0, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID),
    "1.2.840.113619.2.176.2025.4110284.747");
  metaData->Set(2, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID),
    "1.2.840.113619.2.176.2025.4110284.749");
  v2 = metaData->Get(0, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
  TestAssert(v2.AsString() == "1.2.840.113619.2.176.2025.4110284.747");
  v2 = metaData->Get(1, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
  TestAssert(!v2.IsValid());
  v2 = metaData->Get(2, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
  ...
  for (int i = 0; i < 3; i++)
  {
    v2 = metaData->Get(i, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
    TestAssert(v2.AsString() == "1.2.840.113619.2.176.2025.4110284.747");
  }
  ...
  metaData->Set(vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID),
    "1.2.840.113619.2.176.2025.4110284.747");
  metaData->Set(
    1, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID), vtkDICOMValue());
  metaData->Set(2, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID),
    "1.2.840.113619.2.176.2025.4110284.749");
  v2 = metaData->Get(0, vtkDICOMTagPath(DC::ReferencedSeriesSequence, 0, DC::SeriesInstanceUID));
  TestAssert(v2.AsString() == "1.2.840.113619.2.176.2025.4110284.747");
  ...
  TestAssert(mcopy->Get(DC::AcquisitionDateTime).AsString() == acquisitionTime);
