...
int TestDICOMValue(int argc, char* argv[])
{
  ...
  { // test AsUTF8String
    ...
    v = vtkDICOMValue(vtkDICOMVR::LO, vtkDICOMCharacterSet("ISO 2022 IR 13\\ISO 2022 IR 87"),
      "\xd4\xcf\xc0\xde^\xc0\xdb\xb3\\\x1b$B;3ED\x1b(J^\x1b$BB@O:\x1b(J");
    s = "\xef\xbe\x94\xef\xbe\x8f\xef\xbe\x80\xef\xbe\x9e^"
        "\xef\xbe\x80\xef\xbe\x9b\xef\xbd\xb3\\\xe5\xb1\xb1\xe7\x94\xb0^\xe5\xa4\xaa\xe9\x83\x8e";
    TestAssert(v.AsUTF8String() == s);
    // backslash interpreted according to character set
    v = vtkDICOMValue(vtkDICOMVR::LT, vtkDICOMCharacterSet("ISO 2022 IR 13\\ISO 2022 IR 87"),
      "\xd4\xcf\xc0\xde^\xc0\xdb\xb3\\\x1b$B;3ED\x1b(J^\x1b$BB@O:\x1b(J");
    s = "\xef\xbe\x94\xef\xbe\x8f\xef\xbe\x80\xef\xbe\x9e^"
        "\xef\xbe\x80\xef\xbe\x9b\xef\xbd\xb3\xc2\xa5\xe5\xb1\xb1\xe7\x94\xb0^"
  ...
  { // test Matches for query matching
    ...
    v = vtkDICOMValue(vtkDICOMVR::SH, vtkDICOMCharacterSet::ISO_IR_100, "p\373ddle");
    u = vtkDICOMValue(vtkDICOMVR::SH, vtkDICOMCharacterSet::ISO_IR_100, "puddle");
    TestAssert(!v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::SH, vtkDICOMCharacterSet::ISO_IR_6, "p?ddle");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::SH, vtkDICOMCharacterSet::ISO_IR_192, "p\303\273ddle");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::SH, vtkDICOMCharacterSet::ISO_IR_100, "puddle");
    TestAssert(!v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::SH, vtkDICOMCharacterSet::ISO_IR_6, "p?ddle");
    ...
    const char* names[] = { "Gobbi", "Gobbi^David", "Gobbi^^Gregory^", "Gobbi^David^Gregory",
      "Gobb", "Gobbi^Kevin" };
    ...
    v = vtkDICOMValue(vtkDICOMVR::LO, vtkDICOMCharacterSet("ISO 2022 IR 13\\ISO 2022 IR 87"),
      "\xd4\xcf\xc0\xde^\xc0\xdb\xb3\\\x1b$B;3ED\x1b(J^\x1b$BB@O:\x1b(J");
    u = vtkDICOMValue(
      vtkDICOMVR::LO, vtkDICOMCharacterSet("ISO_IR 13"), "\xd4\xcf\xc0\xde^\xc0\xdb\xb3");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::LO, vtkDICOMCharacterSet("ISO 2022 IR 13\\ISO 2022 IR 87"),
      "\x1b$B;3ED\x1b(J^\x1b$BB@O:\x1b(J");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::LO, vtkDICOMCharacterSet("ISO_IR 192"),
    ...
    v = vtkDICOMValue(vtkDICOMVR::PN, vtkDICOMCharacterSet("ISO 2022 IR 13\\ISO 2022 IR 87"),
      "\xd4\xcf\xc0\xde^\xc0\xdb\xb3\\\x1b$B;3ED\x1b(J^\x1b$BB@O:\x1b(J");
    u = vtkDICOMValue(
      vtkDICOMVR::PN, vtkDICOMCharacterSet("ISO_IR 13"), "\xd4\xcf\xc0\xde^\xc0\xdb\xb3");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::PN, vtkDICOMCharacterSet("ISO 2022 IR 13\\ISO 2022 IR 87"),
      "\x1b$B;3ED\x1b(J^\x1b$BB@O:\x1b(J");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::PN, vtkDICOMCharacterSet("ISO_IR 192"),
      "\xef\xbe\x94\xef\xbe\x8f\xef\xbe\x80\xef\xbe\x9e^\xef\xbe\x80\xef\xbe\x9b\xef\xbd\xb3");
    TestAssert(v.Matches(u));
    u = vtkDICOMValue(vtkDICOMVR::PN, vtkDICOMCharacterSet("ISO_IR 192"),
      "\xe5\xb1\xb1\xe7\x94\xb0^\xe5\xa4\xaa\xe9\x83\x8e");
