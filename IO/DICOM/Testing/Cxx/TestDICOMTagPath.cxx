...
int TestDICOMTagPath(int argc, char* argv[])
{
  ...
  { // Test two tag constructor.
    vtkDICOMTagPath tp(vtkDICOMTag(0x0018, 0x0034), 5, vtkDICOMTag(0x7FEE, 0x0010));
  ...
  { // Test three tag constructor.
    vtkDICOMTagPath tp(
      vtkDICOMTag(0x0008, 0x1115), 1, vtkDICOMTag(0x0008, 0x1140), 0, vtkDICOMTag(0x0008, 0x1150));
  ...
  { // Test append constructor.
    vtkDICOMTagPath tp(
      vtkDICOMTag(0x0008, 0x1120), 1, vtkDICOMTag(0x0008, 0x1125), 0, vtkDICOMTag(0x0008, 0x1115));
    vtkDICOMTagPath tp2(tp, 5, vtkDICOMTag(0x0008, 0x1150));
    vtkDICOMTagPath tp3(
      vtkDICOMTag(0x0008, 0x1125), 0, vtkDICOMTag(0x0008, 0x1115), 5, vtkDICOMTag(0x0008, 0x1150));
