...
int TestDICOMSequence(int argc, char* argv[])
{
  ...
  for (iter = ip1->Begin(); iter != ip1->End(); ++iter)
  {
    ...
    {
      found1 = true;
      TestAssert(StringsEqual(
        iter->GetValue().GetCharData(), "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239"));
    }
  ...
  TestAssert(
    StringsEqual(v2.GetCharData(), "1.2.840.113619.2.176.2025.4110284.7478.1276100777.239"));

  // test nested access with tag path
  v2 = seq.Get(0, vtkDICOMTagPath(DC::ReferencedInstanceSequence, 0, DC::ReferencedSOPClassUID));
