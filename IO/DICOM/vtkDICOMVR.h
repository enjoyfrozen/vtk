...
class VTKIODICOM_EXPORT vtkDICOMVR
{
public:
  ...
  enum EnumType
  {
    ...
    OV = 0x22, //!< Other Very Long
    SV = 0x23, //!< Signed Very Long
    UV = 0x24, //!< Unsigned Very Long
  };
  ...
  bool HasLongVL() const { return (((1ull << this->Key) & 0x1cb223e001ull) != 0); }

  //! The VRs SH, LO, PN, ST, LT, UC, and UT use SpecificCharacterSet.
  bool HasSpecificCharacterSet() const { return (((1ull << this->Key) & 0x828c1800ull) != 0); }

  //! This is true for all VRs whose value is stored as text.
  bool HasTextValue() const { return (((1ull << this->Key) & 0xa78c1cf6ull) != 0); }
   ...
   */
  bool HasNumericValue() const { return (((1ull << this->Key) & 0x1848500740ull) != 0); }
   ...
   */
  bool HasSingleValue() const { return (((1ull << this->Key) & 0x80801000ull) != 0); }
  //@}
...
VTKIODICOM_EXPORT ostream& operator<<(ostream& o, const vtkDICOMVR& a);
