...
void ReaderProgress::Execute(vtkObject* object, unsigned long event, void* data)
{
...
int main(int argc, char* argv[])
{
  ...
  for (int j = 0; j < m; j++)
  {
    ...
    for (; k <= kl; k++)
    {
      ...
      vtkSmartPointer<ReaderProgress> progressCommand = vtkSmartPointer<ReaderProgress>::New();
