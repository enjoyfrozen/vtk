...
protected:
  vtkDICOMPrinter(){};
  vtkDICOMPrinter(const vtkDICOMPrinter& c)
    : vtkCommand(c)
  {
  }
...
int main(int argc, char* argv[])
{
  ...
  vtkSmartPointer<vtkDICOMDirectory> sorter = vtkSmartPointer<vtkDICOMDirectory>::New();
  ...
  vtkSmartPointer<vtkImageMapToColors> colorOverlay = vtkSmartPointer<vtkImageMapToColors>::New();
  ...
  for (int i = 2 * (imageIs3D == 0); i < 3; i++)
  {
    ...
    vtkSmartPointer<vtkImageSlice> overlay = vtkSmartPointer<vtkImageSlice>::New();
  ...
  {
    cout << "VectorDimension: " << reader->GetFileIndexArray()->GetNumberOfComponents() << "\n";
  }
