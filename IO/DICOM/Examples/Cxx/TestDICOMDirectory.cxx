...
int main(int argc, char* argv[])
{
  ...
  for (int i = 0; i < n; i++)
  {
    ...
    cout << "Patient " << i << ": " << patientItem.Get(DC::PatientID).AsString() << "\n";
    ...
    for (vtkIdType jj = 0; jj < m; jj++)
    {
      ...
      cout << " Study " << j << ": \"" << studyItem.Get(DC::StudyDescription).AsString() << "\" \""
      ...
      for (int k = k0; k <= k1; k++)
      {
        ...
        cout << "  Series " << k << ": \"" << seriesItem.Get(DC::SeriesDescription).AsString()
