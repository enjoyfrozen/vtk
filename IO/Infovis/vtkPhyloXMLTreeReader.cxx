  ...
  vtkXMLDataElement* element, vtkMutableDirectedGraph* g, vtkIdType vertex)
{
  ...
  if (typeOfData == "string" || typeOfData == "duration" ||
    typeOfData == "dateTime" || typeOfData == "time" ||
    typeOfData == "date" || typeOfData == "gYearMonth" ||
    typeOfData == "gYear" || typeOfData == "gMonthDay" ||
    typeOfData == "gDay" || typeOfData == "gMonth" ||
    typeOfData == "anyURI" || typeOfData == "normalizedString" ||
    typeOfData == "token" || typeOfData == "hexBinary" ||
    typeOfData == "base64Binary")
  {
  ...
  else if (typeOfData == "decimal" || typeOfData == "float" ||
    typeOfData == "double")
  {
    if (!g->GetVertexData()->HasArray(propertyName.c_str()))
    {
  ...
  else if (typeOfData == "int" || typeOfData == "integer" ||
    typeOfData == "nonPositiveInteger" || typeOfData == "negativeInteger")
  {
    if (!g->GetVertexData()->HasArray(propertyName.c_str()))
    {
  ...
  else if (typeOfData == "nonNegativeInteger" ||
    typeOfData == "positiveInteger" || typeOfData == "unsignedInt")
  {
    if (!g->GetVertexData()->HasArray(propertyName.c_str()))
    {
