            ...
            polygonType, materialIndex, materialIndexToPolyData, imageURI, imageURIToPolyData))
      {
        ...
        switch (polygonType)
        {
          ...
          case PolygonType::MATERIAL:
          {
            ...
            vtkCityGMLReader::Implementation::SetField(polyData, "diffuse_color", &material.Diffuse[0], 3);
            vtkCityGMLReader::Implementation::SetField(polyData, "specular_color", &material.Specular[0], 3);
            vtkCityGMLReader::Implementation::SetField(polyData, "transparency", &material.Transparency, 1);
            break;
          }
          case PolygonType::NONE:
          default:
