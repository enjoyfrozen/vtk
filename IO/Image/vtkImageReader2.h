...
public:
  ...
  ///@{
  /**
   * Set/Get the red and green components swapping.
   */
  vtkSetMacro(SwapRGComps, vtkTypeBool);
  vtkGetMacro(SwapRGComps, vtkTypeBool);
  vtkBooleanMacro(SwapRGComps, vtkTypeBool);
  ///@}
