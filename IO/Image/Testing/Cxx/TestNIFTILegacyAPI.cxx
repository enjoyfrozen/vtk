  ...
  const char* infile, const char* infile2, const char* outfile, bool planarRGB)
{
  ...
  reader->AllowSliceReorderingOn();
  reader->UseDirectionAndOriginOff();
  ...
  // backwards compatibility flags
  reader2->AllowSliceReorderingOn();
  reader2->UseDirectionAndOriginOff();
...
int TestNIFTILegacyAPI(int argc, char* argv[])
{
