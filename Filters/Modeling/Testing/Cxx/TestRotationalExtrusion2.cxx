...
int TestRotationalExtrusion2(int argc, char* argv[])
{
  ...
  camera->SetFocalPoint(0.48072855985426116, 0.26208905517647146, 0.748307168745063);
  camera->SetPosition(3.8192076994479733, 5.925098620384546, 2.0010998050922453);
