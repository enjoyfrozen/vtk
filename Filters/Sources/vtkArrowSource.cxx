...
//------------------------------------------------------------------------------
const char* vtkArrowSource::GetArrowOriginAsString()
{
  switch (this->ArrowOrigin)
  {
    case vtkArrowSource::Default:
      return "Default";
    case vtkArrowSource::Center:
      return "Center";
  }
  return "Invalid";
}
