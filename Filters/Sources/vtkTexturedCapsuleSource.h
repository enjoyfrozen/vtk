 ...
 *
 * vtkTexturedCapsuleSource creates a capsule (represented by polygons) of specified
 ...
 * well as the length of the capsule cylinder (CylinderLength).
 */

#ifndef vtkTexturedCapsuleSource_h
#define vtkTexturedCapsuleSource_h

#include "vtkFiltersSourcesModule.h" // For export macro
#include "vtkPolyDataAlgorithm.h"

VTK_ABI_NAMESPACE_BEGIN
class VTKFILTERSSOURCES_EXPORT vtkTexturedCapsuleSource : public vtkPolyDataAlgorithm
{
public:
   ...
   * lines. This functionality currently achieves nothing.
   *
...
protected:
  vtkTexturedCapsuleSource(int res = 8);
