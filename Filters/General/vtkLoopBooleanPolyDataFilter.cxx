...
int vtkLoopBooleanPolyDataFilter::Impl::FindRegion(int inputIndex,
...
int vtkLoopBooleanPolyDataFilter::Impl::FindRegionTipToe(
    ...
    vtkInformationVector*  outputVector)
{
  ...
  vtkLoopBooleanPolyDataFilter::Impl *impl =
    new vtkLoopBooleanPolyDataFilter::Impl();
...
//-----------------------------------------------------------------------------
void vtkLoopBooleanPolyDataFilter::PrintSelf(
...
//-----------------------------------------------------------------------------
int vtkLoopBooleanPolyDataFilter::FillInputPortInformation(
...
void vtkLoopBooleanPolyDataFilter::Impl::DetermineIntersection(
    std::vector<simLoop> *loops)
{
...
void vtkLoopBooleanPolyDataFilter::Impl::PerformBoolean(
