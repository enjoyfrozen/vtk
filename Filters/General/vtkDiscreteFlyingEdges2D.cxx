...
public:
  ...
  void InterpolateAxesEdge(double vtkNotUsed(value), T* vtkNotUsed(s0),
                           int ijk0[3], T* vtkNotUsed(s1),
  ...
  {
    public:
      Pass2(vtkDiscreteFlyingEdges2DAlgorithm<TT> *algo)
        { this->Algo = algo;}
      vtkDiscreteFlyingEdges2DAlgorithm<TT> *Algo;
      void  operator()(vtkIdType row, vtkIdType end)
      {
...
template <class T> const unsigned char vtkDiscreteFlyingEdges2DAlgorithm<T>::
...
template <class T> vtkDiscreteFlyingEdges2DAlgorithm<T>::
vtkDiscreteFlyingEdges2DAlgorithm():XCases(nullptr),EdgeMetaData(nullptr),Scalars(nullptr),
...
template <class T> void vtkDiscreteFlyingEdges2DAlgorithm<T>::
InterpolateEdge(double vtkNotUsed(value), T* vtkNotUsed(s), int ijk[3],
...
//
template <class T> void vtkDiscreteFlyingEdges2DAlgorithm<T>::
ContourImage(vtkDiscreteFlyingEdges2D *self, T *scalars, vtkPoints *newPts,
             vtkDataArray *newScalars, vtkCellArray *newLines,
             vtkImageData *input, int *updateExt)
{
  ...
  vtkInformationVector **inputVector, vtkInformationVector *outputVector)
{
  ...
  {
    vtkTemplateMacro(vtkDiscreteFlyingEdges2DAlgorithm<VTK_TT>::
