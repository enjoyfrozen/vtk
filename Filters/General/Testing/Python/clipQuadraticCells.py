...
BQpyraScalars.InsertValue(18, 0.0)
...
BQpyraClips = vtk.vtkClipDataSet()
BQpyraClips.SetInputData(aBQPyramidGrid)
BQpyraClips.SetValue(0.5)
aBQPyramidClipMapper = vtk.vtkDataSetMapper()
aBQPyramidClipMapper.SetInputConnection(BQpyraClips.GetOutputPort())
aBQPyramidClipMapper.ScalarVisibilityOff()
...
aBQPyramidClipActor = vtk.vtkActor()
aBQPyramidClipActor.SetMapper(aBQPyramidClipMapper)
aBQPyramidClipActor.GetProperty().SetAmbient(1.0)
...
ren1.AddActor(aBQPyramidClipActor)
...
aBQPyramidClipActor.AddPosition(12, 2, 2)
