...
int TestBooleanOperationPolyDataFilter6(int argc, char* argv[])
{
  ...
  std::string skull = dataRoot + "/Data/BooleanClipping/skull_for_cc5_rc1_rc5.vtk";
  std::string chamber = dataRoot + "/Data/BooleanClipping/chamber__rc1.vtk";
