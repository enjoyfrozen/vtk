...
class VTKFILTERSGENERAL_EXPORT vtkTableFFT final : public vtkTableAlgorithm
{
public:
  ...
  //@{
  /**
   * Specify if the filter should use the optimized discrete dourier transform for
