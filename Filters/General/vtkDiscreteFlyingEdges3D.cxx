...
public:
  ...
  {
    public:
      Pass2(vtkDiscreteFlyingEdges3DAlgorithm<TT> *algo)
        {this->Algo = algo;}
      vtkDiscreteFlyingEdges3DAlgorithm<TT> *Algo;
      void  operator()(vtkIdType slice, vtkIdType end)
      {
  ...
  static void Contour(vtkDiscreteFlyingEdges3D *self, vtkImageData *input,
...
template <class T> vtkDiscreteFlyingEdges3DAlgorithm<T>::
vtkDiscreteFlyingEdges3DAlgorithm():XCases(nullptr),EdgeMetaData(nullptr),NewScalars(nullptr),
...
template <class T> void vtkDiscreteFlyingEdges3DAlgorithm<T>::
Contour(vtkDiscreteFlyingEdges3D *self, vtkImageData *input, vtkDataArray *inScalars,
...
//----------------------------------------------------------------------------
int vtkDiscreteFlyingEdges3D::RequestUpdateExtent(
  ...
  vtkInformationVector *outputVector)
{
  ...
  {
    vtkTemplateMacro(vtkDiscreteFlyingEdges3DAlgorithm<VTK_TT>::
