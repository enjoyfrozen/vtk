...
public:
  ...
  public:
    ...
    Pass1(
      vtkDiscreteFlyingEdges3DAlgorithm<TT>* algo, double value, vtkDiscreteFlyingEdges3D* filter)
    {
      this->Algo = algo;
      this->Value = value;
      this->Filter = filter;
  ...
  {
  public:
    Pass2(vtkDiscreteFlyingEdges3DAlgorithm<TT>* algo, vtkDiscreteFlyingEdges3D* filter)
    {
      this->Algo = algo;
      this->Filter = filter;
    }
