 ...
 * in the file format to save out various mode shapes. In that case, the time as
 * provided by the reader, is not really time but identifies a mode shape.
 * vtkAnimateModes can be used to reinterpret time as mode shapes. The filter
 * can also animate vibrations for each mode shape.
 *
