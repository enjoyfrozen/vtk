...
int TestDescriptiveStatistics(int, char*[])
{
  ...
  vtkDoubleArray* vals1 =
    vtkArrayDownCast<vtkDoubleArray>(outputData1->GetColumnByName("Metric 1"));
  vtkDoubleArray* devs0 =
    vtkArrayDownCast<vtkDoubleArray>(outputData1->GetColumnByName("d(Metric 0)"));
  vtkDoubleArray* devs1 =
    vtkArrayDownCast<vtkDoubleArray>(outputData1->GetColumnByName("d(Metric 1)"));
  ...
  {
    vtkGenericWarningMacro("Rejected only " << nRejected << " null hypotheses of normality whereas "
