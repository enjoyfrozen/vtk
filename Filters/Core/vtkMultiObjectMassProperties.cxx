...
struct ComputeProperties
{
  ...
  ComputeProperties(vtkPolyData *mesh, double center[3], unsigned char *orient,
                    double *areas, double *volumes) :
    Mesh(mesh), Orient(orient), Areas(areas), Volumes(volumes)
  {
...
int vtkMultiObjectMassProperties::RequestData(
  ...
  vtkInformationVector* outputVector )
{
  ...
  if ( !this->SkipValidityCheck ||
       objectIdsArray == nullptr || objectIdsArray->GetDataType() != VTK_ID_TYPE )
  {
...
void vtkMultiObjectMassProperties::
