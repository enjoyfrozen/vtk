...
namespace
{
  ...
  vtkSmartPointer<vtkPolyData> ConstructPolys()
  {
    ...
    // Construct a triangle (0, 4, 0) degenerated to a vertex ONLY if merging is ON or degenerated to a line if merging is OFF
    ptIds[0] = 0;
    ptIds[1] = 4;
    ptIds[2] = 0;
    degeneratedPolys->InsertNextCell(3, ptIds);
  ...
  vtkSmartPointer<vtkPolyData> ConstructStrips()
  {
    ...
    // Construct a strip (0, 0, 6, 5) degenerated to a line ONLY if merging is ON or degenerated to a triangle if merging is OFF
    ptIds[0] = 0;
    ptIds[1] = 0;
    ptIds[2] = 6;
    ptIds[3] = 5;
    ...
    // Construct a strip (0, 0, 0, 5) degenerated to a vertex ONLY if merging is ON or degenerated to a line if merging is OFF
    ptIds[0] = 0;
    ptIds[1] = 0;
    ptIds[2] = 0;
    ptIds[3] = 5;
  ...
  bool UpdateAndTestCleanPolyData(
    vtkSmartPointer<vtkCleanPolyData> clean,
    int numExpectedPoints,
    int numExpectedVertices,
    int numExpectedLines,
    int numExpectedPolys,
    int numExpectedStrips)
    {
      clean->Update();
