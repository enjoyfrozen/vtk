...
# BiQuadratic pyramid
BQpyraPoints = vtk.vtkPoints()
BQpyraPoints.SetNumberOfPoints(19)
BQpyraPoints.InsertPoint(0, 0, 0, 0)
BQpyraPoints.InsertPoint(1, 1, 0, 0)
BQpyraPoints.InsertPoint(2, 1, 1, 0)
BQpyraPoints.InsertPoint(3, 0, 1, 0)
BQpyraPoints.InsertPoint(4, 0, 0, 1)
BQpyraPoints.InsertPoint(5, 0.5, 0, 0)
BQpyraPoints.InsertPoint(6, 1, 0.5, 0)
BQpyraPoints.InsertPoint(7, 0.5, 1, 0)
BQpyraPoints.InsertPoint(8, 0, 0.5, 0)
BQpyraPoints.InsertPoint(9, 0, 0, 0.5)
BQpyraPoints.InsertPoint(10, 0.5, 0, 0.5)
BQpyraPoints.InsertPoint(11, 0.5, 0.5, 0.5)
BQpyraPoints.InsertPoint(12, 0, 0.5, 0.5)
BQpyraPoints.InsertPoint(13, 0.5, 0.5, 0)
BQpyraPoints.InsertPoint(14, 1.0 / 3.0, 0, 1.0 / 3.0)
BQpyraPoints.InsertPoint(15, 2.0 / 3.0, 1.0 / 3.0, 1.0 / 3.0)
BQpyraPoints.InsertPoint(16, 1.0 / 3.0, 2.0 / 3.0, 1.0 / 3.0)
BQpyraPoints.InsertPoint(17, 0, 1.0 / 3.0, 1.0 / 3.0)
BQpyraPoints.InsertPoint(18, 41.0 / 108.0, 41.0 / 108.0, 26.0 / 108.0)
BQpyraScalars = vtk.vtkFloatArray()
BQpyraScalars.SetNumberOfTuples(19)
BQpyraScalars.InsertValue(0, 1.0)
BQpyraScalars.InsertValue(1, 1.0)
BQpyraScalars.InsertValue(2, 1.0)
BQpyraScalars.InsertValue(3, 1.0)
BQpyraScalars.InsertValue(4, 1.0)
BQpyraScalars.InsertValue(5, 0.0)
BQpyraScalars.InsertValue(6, 0.0)
BQpyraScalars.InsertValue(7, 0.0)
BQpyraScalars.InsertValue(8, 0.0)
BQpyraScalars.InsertValue(9, 0.0)
BQpyraScalars.InsertValue(10, 0.0)
BQpyraScalars.InsertValue(11, 0.0)
BQpyraScalars.InsertValue(12, 0.0)
BQpyraScalars.InsertValue(13, 0.0)
BQpyraScalars.InsertValue(14, 0.0)
BQpyraScalars.InsertValue(15, 0.0)
BQpyraScalars.InsertValue(16, 0.0)
BQpyraScalars.InsertValue(17, 0.0)
BQpyraScalars.InsertValue(18, 1.0)
aBQPyramid = vtk.vtkBiQuadraticPyramid()
aBQPyramid.GetPointIds().SetId(0, 0)
aBQPyramid.GetPointIds().SetId(1, 1)
aBQPyramid.GetPointIds().SetId(2, 2)
aBQPyramid.GetPointIds().SetId(3, 3)
aBQPyramid.GetPointIds().SetId(4, 4)
aBQPyramid.GetPointIds().SetId(5, 5)
aBQPyramid.GetPointIds().SetId(6, 6)
aBQPyramid.GetPointIds().SetId(7, 7)
aBQPyramid.GetPointIds().SetId(8, 8)
aBQPyramid.GetPointIds().SetId(9, 9)
aBQPyramid.GetPointIds().SetId(10, 10)
aBQPyramid.GetPointIds().SetId(11, 11)
aBQPyramid.GetPointIds().SetId(12, 12)
aBQPyramid.GetPointIds().SetId(13, 13)
aBQPyramid.GetPointIds().SetId(14, 14)
aBQPyramid.GetPointIds().SetId(15, 15)
aBQPyramid.GetPointIds().SetId(16, 16)
aBQPyramid.GetPointIds().SetId(17, 17)
aBQPyramid.GetPointIds().SetId(18, 18)
aBQPyramidGrid = vtk.vtkUnstructuredGrid()
aBQPyramidGrid.Allocate(1, 1)
aBQPyramidGrid.InsertNextCell(aBQPyramid.GetCellType(), aBQPyramid.GetPointIds())
aBQPyramidGrid.SetPoints(BQpyraPoints)
aBQPyramidGrid.GetPointData().SetScalars(BQpyraScalars)
BQpyraContours = vtk.vtkContourFilter()
BQpyraContours.SetInputData(aBQPyramidGrid)
BQpyraContours.SetValue(0, 0.5)
aBQPyramidContourMapper = vtk.vtkDataSetMapper()
aBQPyramidContourMapper.SetInputConnection(BQpyraContours.GetOutputPort())
aBQPyramidContourMapper.ScalarVisibilityOff()
aBQPyramidMapper = vtk.vtkDataSetMapper()
aBQPyramidMapper.SetInputData(aBQPyramidGrid)
aBQPyramidMapper.ScalarVisibilityOff()
aBQPyramidActor = vtk.vtkActor()
aBQPyramidActor.SetMapper(aBQPyramidMapper)
aBQPyramidActor.GetProperty().SetRepresentationToWireframe()
aBQPyramidActor.GetProperty().SetAmbient(1.0)
aBQPyramidContourActor = vtk.vtkActor()
aBQPyramidContourActor.SetMapper(aBQPyramidContourMapper)
aBQPyramidContourActor.GetProperty().SetAmbient(1.0)
...
ren1.AddActor(aBQPyramidActor)
ren1.AddActor(aBQPyramidContourActor)
...
aBQPyramidActor.AddPosition(12, 0, 2)
aPyramidContourActor.AddPosition(12, 2, 0)
aBQPyramidContourActor.AddPosition(12, 2, 2)
