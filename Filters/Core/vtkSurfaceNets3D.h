...
public:
  ...
  void SetConstraintBox(double sx, double sy, double sz) {this->Smoother->SetConstraintBox(sx,sy,sz);};
  ...
  void SetConstraintStrategyToConstraintDistance() {this->Smoother->SetConstraintStrategyToConstraintDistance();}
  void SetConstraintStrategyToConstraintBox() {this->Smoother->SetConstraintStrategyToConstraintBox();}
