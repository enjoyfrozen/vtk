...
struct ParticleTracerFunctor
{
  ...
  void operator()(vtkIdType begin, vtkIdType end)
  {
    ...
    for (vtkIdType i = begin; i < end; ++i)
    {
      ...
      this->PT->IntegrateParticle(it, this->FromTime, this->PT->CurrentTimeValue, integrator,
        interpolator, cellVectors, this->ParticleCount, this->Sequential);
...
void vtkParticleTracerBase::IntegrateParticle(ParticleListIterator& it, double currentTime,
  ...
  std::atomic<vtkIdType>& particleCount, bool sequential)
{
