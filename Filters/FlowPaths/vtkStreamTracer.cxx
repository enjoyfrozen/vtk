...
//------------------------------------------------------------------------------
// The outputPD is a point data containing the common data arrays across all
// datasets in composite data.
int vtkStreamTracer::
...
struct TracerIntegrator
{
  ...
  TracerIntegrator(vtkStreamTracer *streamTracer, bool matchingAttr, vtkDataSetAttributes *protoPD,
                   ...
                   std::vector<void*> &customTerminationClientData,
                   std::vector<int> &customReasonForTermination) :
    StreamTracer(streamTracer), HasMatchingPointAttributes(matchingAttr),
...
Integrate(vtkPointData* vtkNotUsed(input0Data), vtkPolyData* output,
          ...
          std::vector<int> &customReasonForTermination)
{
  ...
  this->InputPD.BuildPrototype(protoPD);

  // Generate streamlines.
  TracerIntegrator ti(this, this->HasMatchingPointAttributes, protoPD,
