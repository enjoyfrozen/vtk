...
//------------------------------------------------------------------------------
void vtkCellLocatorInterpolatedVelocityField::
SetCellLocatorPrototype(vtkAbstractCellLocator* prototype)
{
  ...
  vtkCellLocatorStrategy::SafeDownCast(this->FindCellStrategy)->
      SetCellLocator(prototype);
}
