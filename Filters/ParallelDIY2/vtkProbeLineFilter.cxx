  ...
  vtkInformation*, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  for (samplerCellsIt->InitTraversal(); !samplerCellsIt->IsDoneWithTraversal(); samplerCellsIt->GoToNextCell())
  {
    ...
    else if (!nonLineCellFound)
    {
      vtkWarningMacro("Found non Line/PolyLine cell(s) in the prober source: ignoring these cells.");
      nonLineCellFound = true;
    }
  } // end for each cell
