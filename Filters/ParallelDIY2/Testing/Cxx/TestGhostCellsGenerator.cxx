  ...
  vtkMultiProcessController* controller, int myrank, int numberOfGhostLayers)
{
  ...
  // We take the same input as previously, but add global ids, and edits some that should match
  // accross partitions so they do not. The ghost cell generator should ignore point positions in
