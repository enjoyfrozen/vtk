 ...
 *
 * If the input is a `vtkPartitionedDataSetCollection`, then ghosts are computed per partitioned data
 * set. In other words, ghost are not computed between 2 `vtkDataSet` belonging to 2 different
