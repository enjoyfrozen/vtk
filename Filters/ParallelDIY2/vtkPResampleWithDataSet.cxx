...
{
  FlattenCompositeDataset(std::vector<vtkDataSet*>& blocks)
    : Blocks(&blocks)
  {
  }

  void operator()(vtkDataSet* block) const { this->Blocks->push_back(block); }
...
public:
  ...
  void SetPointIds(const std::vector<vtkIdType>& pointIds) { this->PointIds = &pointIds; }
