/*=========================================================================
  ...
  Module:    vtkPointSetToOctreeImageFilter.h
 ...
 * a vtkPartitionedDataset with one vtkImageData that has with a specific size and uniform spacing.
 *
 * The reason we output a vtkPartitionedDataset is because the WHOLE_EXTENT needs to
 * be dynamic.
 *
