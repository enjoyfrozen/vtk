...
#define vtkGridDataSetExecuteMacro(gridName)                                                       \
  gridName* grid = gridName::SafeDownCast(input);                                                  \
  ...
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  switch (input->GetDataObjectType())
  {
    ...
    {
      vtkGridDataSetExecuteMacro(vtkRectilinearGrid);
    }
    case VTK_STRUCTURED_GRID:
    {
      vtkGridDataSetExecuteMacro(vtkStructuredGrid);
    }
    case VTK_UNIFORM_GRID:
    case VTK_STRUCTURED_POINTS:
    case VTK_IMAGE_DATA:
    {
      vtkGridDataSetExecuteMacro(vtkImageData);
    }
    case VTK_POLY_DATA:
    {
