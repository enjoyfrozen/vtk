...
#ifndef vtkDiscoverRegions_h
#define vtkDiscoverRegions_h
 ...
 */
class VTKFILTERSGEOMETRY_EXPORT vtkDiscoverRegions : public vtkPolyDataAlgorithm
{
public:
