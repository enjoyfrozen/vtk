...
int UnitTestDataSetSurfaceFilter(int, char*[])
{
  ...
  }
  {
    ...
    typesToProcess["BiQuadraticPyramid"] = test::CellDescription(VTK_BIQUADRATIC_PYRAMID, 32);
...
{
  vtkSmartPointer<vtkUniformGrid> image = vtkSmartPointer<vtkUniformGrid>::New();
