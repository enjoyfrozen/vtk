...
int TestUnstructuredGridGeometryFilter(int argc, char* argv[])
{
  ...
  // 3D: biquadratic pyramid: 3 pyramids, some share the base quad face,
  // some share a triangle face
  xOffset += 2.0;
  ...
  // 38=(0+1+2+3+4+8+9+10+11+12+13+14+15+25+26+27+28+29)/18
  points->InsertNextPoint(xOffset + 0.5, yOffset + 13.0 / 54.0, -0.5);
  scalars->InsertNextValue(scalar);
  scalar += scalarStep;

  // 39=(3+2+1+0+10+9+8+11+16+17+18+19+25+30+31+32+33)/18
  points->InsertNextPoint(xOffset + 0.5, yOffset - 13.0 / 54.0, -0.5);
  scalars->InsertNextValue(scalar);
  scalar += scalarStep;

  // 40=(1+6+7+2+4+20+21+22+9+13+23+24+14+37+35+36+37+27)/18
  points->InsertNextPoint(xOffset + 34.0 / 27.0, yOffset + 13.0 / 54.0, -0.5);
  scalars->InsertNextValue(scalar);
  scalar += scalarStep;

  auto biQuadraticPyramid = vtkSmartPointer<vtkBiQuadraticPyramid>::New();
  biQuadraticPyramid->GetPointIds()->SetId(0, pointId);
  biQuadraticPyramid->GetPointIds()->SetId(1, pointId + 1);
  biQuadraticPyramid->GetPointIds()->SetId(2, pointId + 2);
  biQuadraticPyramid->GetPointIds()->SetId(3, pointId + 3);
  biQuadraticPyramid->GetPointIds()->SetId(4, pointId + 4);

  biQuadraticPyramid->GetPointIds()->SetId(5, pointId + 8);
  biQuadraticPyramid->GetPointIds()->SetId(6, pointId + 9);
  biQuadraticPyramid->GetPointIds()->SetId(7, pointId + 10);
  biQuadraticPyramid->GetPointIds()->SetId(8, pointId + 11);

  biQuadraticPyramid->GetPointIds()->SetId(9, pointId + 12);
  biQuadraticPyramid->GetPointIds()->SetId(10, pointId + 13);
  biQuadraticPyramid->GetPointIds()->SetId(11, pointId + 14);
  biQuadraticPyramid->GetPointIds()->SetId(12, pointId + 15);

  biQuadraticPyramid->GetPointIds()->SetId(13, pointId + 25);
  biQuadraticPyramid->GetPointIds()->SetId(14, pointId + 26);
  biQuadraticPyramid->GetPointIds()->SetId(15, pointId + 27);
  biQuadraticPyramid->GetPointIds()->SetId(16, pointId + 28);
  biQuadraticPyramid->GetPointIds()->SetId(17, pointId + 29);

  biQuadraticPyramid->GetPointIds()->SetId(18, pointId + 38);

  cellIds->InsertNextValue(cellId);
  ++cellId;
  grid->InsertNextCell(biQuadraticPyramid->GetCellType(), biQuadraticPyramid->GetPointIds());

  biQuadraticPyramid = vtkSmartPointer<vtkBiQuadraticPyramid>::New();
  biQuadraticPyramid->GetPointIds()->SetId(0, pointId + 3);
  biQuadraticPyramid->GetPointIds()->SetId(1, pointId + 2);
  biQuadraticPyramid->GetPointIds()->SetId(2, pointId + 1);
  biQuadraticPyramid->GetPointIds()->SetId(3, pointId);
  biQuadraticPyramid->GetPointIds()->SetId(4, pointId + 5);

  biQuadraticPyramid->GetPointIds()->SetId(5, pointId + 10);
  biQuadraticPyramid->GetPointIds()->SetId(6, pointId + 9);
  biQuadraticPyramid->GetPointIds()->SetId(7, pointId + 8);
  biQuadraticPyramid->GetPointIds()->SetId(8, pointId + 11);

  biQuadraticPyramid->GetPointIds()->SetId(9, pointId + 16);
  biQuadraticPyramid->GetPointIds()->SetId(10, pointId + 17);
  biQuadraticPyramid->GetPointIds()->SetId(11, pointId + 18);
  biQuadraticPyramid->GetPointIds()->SetId(12, pointId + 19);

  biQuadraticPyramid->GetPointIds()->SetId(13, pointId + 25);
  biQuadraticPyramid->GetPointIds()->SetId(14, pointId + 30);
  biQuadraticPyramid->GetPointIds()->SetId(15, pointId + 31);
  biQuadraticPyramid->GetPointIds()->SetId(16, pointId + 32);
  biQuadraticPyramid->GetPointIds()->SetId(17, pointId + 33);

  biQuadraticPyramid->GetPointIds()->SetId(18, pointId + 39);
  ...
  biQuadraticPyramid = vtkSmartPointer<vtkBiQuadraticPyramid>::New();
  biQuadraticPyramid->GetPointIds()->SetId(0, pointId + 1);
  biQuadraticPyramid->GetPointIds()->SetId(1, pointId + 6);
  biQuadraticPyramid->GetPointIds()->SetId(2, pointId + 7);
  biQuadraticPyramid->GetPointIds()->SetId(3, pointId + 2);
  biQuadraticPyramid->GetPointIds()->SetId(4, pointId + 4);

  biQuadraticPyramid->GetPointIds()->SetId(5, pointId + 20);
  biQuadraticPyramid->GetPointIds()->SetId(6, pointId + 21);
  biQuadraticPyramid->GetPointIds()->SetId(7, pointId + 22);
  biQuadraticPyramid->GetPointIds()->SetId(8, pointId + 9);

  biQuadraticPyramid->GetPointIds()->SetId(9, pointId + 13);
  biQuadraticPyramid->GetPointIds()->SetId(10, pointId + 23);
  biQuadraticPyramid->GetPointIds()->SetId(11, pointId + 24);
  biQuadraticPyramid->GetPointIds()->SetId(12, pointId + 14);

  biQuadraticPyramid->GetPointIds()->SetId(13, pointId + 34);
  biQuadraticPyramid->GetPointIds()->SetId(14, pointId + 35);
  biQuadraticPyramid->GetPointIds()->SetId(15, pointId + 36);
  biQuadraticPyramid->GetPointIds()->SetId(16, pointId + 37);
  biQuadraticPyramid->GetPointIds()->SetId(17, pointId + 27);

  biQuadraticPyramid->GetPointIds()->SetId(18, pointId + 40);
