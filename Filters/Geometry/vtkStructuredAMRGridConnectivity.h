...
public:
   ...
   */
  void Initialize(
    unsigned int NumberOfLevels, unsigned int N, int RefinementRatio = -1);
   ...
   */
  virtual void RegisterGrid(int gridIdx, int level, int refinementRatio,
...
protected:
   ...
   */
  void GetCellRefinedExtent(int orient[3], int ndim, int i, int j, int k,
    int fromLevel, int toLevel, int ext[6]);
  ...
  void GetNodeOrientation(
    int i, int j, int k, int gridExt[6], int nodeOrientation[3]);
   ...
   */
  virtual void MarkNodeProperty(int gridId, int i, int j, int k,
   ...
   */
  vtkStructuredAMRNeighbor GetAMRNeighbor(int i, int iLevel, int next1[6], int j,
    int jLevel, int next2[6], int normalizedLevel, int levelDiff,
   ...
   */
  void ComputeAMRNeighborOverlapExtents(int iLevel, int jLevel,
   ...
   * Get 1-D orientation.
   */
  int Get1DOrientation(int idx, int ExtentLo, int ExtentHi, int OnLo,
    int OnHi, int NotOnBoundary);
   ...
   */
  void AverageFieldData(vtkFieldData* source, vtkIdType* sourceIds, int N,
...
//------------------------------------------------------------------------------
inline int vtkStructuredAMRGridConnectivity::Get1DOrientation(int idx, int ExtentLo,
  int ExtentHi, int OnLo, int OnHi, int NotOnBoundary)
{
  if (idx == ExtentLo)
  {
    return OnLo;
