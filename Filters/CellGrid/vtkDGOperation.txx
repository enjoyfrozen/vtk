...
template<typename InputIterator, typename OutputIterator>
bool vtkDGOperation<InputIterator, OutputIterator>::Prepare(
...
template<typename InputIterator, typename OutputIterator>
void vtkDGOperation<InputIterator, OutputIterator>::AddSource(
  vtkCellGrid* grid,
  ...
  if (isCellSpec)
  {
      ...
      case InverseJacobian:
        {
          if (shapeSharing)
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Cells, InverseJacobian, SharedDOF>::prepEntry(
                entry, op, cellSpec.Connectivity, values, nullptr, source.Offset,
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Cells, InverseJacobian, Discontinuous>::prepEntry(
                entry, op, cellSpec.Connectivity, values, nullptr, source.Offset,
      ...
      case ScaledJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Cells, ScaledJacobian, SharedDOF>::prepEntry(
                entry, op, cellSpec.Connectivity, values, nullptr, source.Offset,
                shapeGradient, shapeConn, shapeValues);
          }
          else
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Cells, ScaledJacobian, Discontinuous>::prepEntry(
                entry, op, cellSpec.Connectivity, values, nullptr, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
    ...
    else
    {
      ...
      case None:
        {
          vtkDGOperationEvaluator<
            InputIterator, OutputIterator, Discontinuous, Cells, None>::prepEntry(
      ...
      case InverseJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Cells, InverseJacobian, SharedDOF>::prepEntry(
                entry, op, nullptr, values, nullptr, source.Offset,
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Cells, InverseJacobian, Discontinuous>::prepEntry(
                entry, op, nullptr, values, nullptr, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
      ...
      case ScaledJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Cells, ScaledJacobian, SharedDOF>::prepEntry(
                entry, op, nullptr, values, nullptr, source.Offset,
                shapeGradient, cellSpec.Connectivity, shapeValues);
          }
          else
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Cells, ScaledJacobian, Discontinuous>::prepEntry(
                entry, op, nullptr, values, nullptr, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
  ...
  else
  {
    ...
    if (sharedDOF)
    {
      ...
      case None:
        {
          vtkDGOperationEvaluator<
            InputIterator, OutputIterator, SharedDOF, Sides, None>::prepEntry(
      ...
      case InverseJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Sides, InverseJacobian, SharedDOF>::prepEntry(
                entry, op, cellSpec.Connectivity, values, source.Connectivity, source.Offset,
                shapeGradient, shapeConn, shapeValues);
          }
          else
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Sides, InverseJacobian, Discontinuous>::prepEntry(
                entry, op, cellSpec.Connectivity, values, source.Connectivity, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
      ...
      case ScaledJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Sides, ScaledJacobian, SharedDOF>::prepEntry(
                entry, op, cellSpec.Connectivity, values, source.Connectivity, source.Offset,
                shapeGradient, shapeConn, shapeValues);
          }
          else
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, SharedDOF, Sides, ScaledJacobian, Discontinuous>::prepEntry(
                entry, op, cellSpec.Connectivity, values, source.Connectivity, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
    ...
    else
    {
      ...
      case None:
        {
          vtkDGOperationEvaluator<
            InputIterator, OutputIterator, Discontinuous, Sides, None>::prepEntry(
      ...
      case InverseJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Sides, InverseJacobian, SharedDOF>::prepEntry(
                entry, op, nullptr, values, source.Connectivity, source.Offset,
                shapeGradient, shapeConn, shapeValues);
          }
          else
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Sides, InverseJacobian, Discontinuous>::prepEntry(
                entry, op, nullptr, values, source.Connectivity, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
      ...
      case ScaledJacobian:
        {
          ...
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Sides, ScaledJacobian, SharedDOF>::prepEntry(
                entry, op, nullptr, values, source.Connectivity, source.Offset,
                shapeGradient, shapeConn, shapeValues);
          }
          else
          {
            vtkDGOperationEvaluator<
              InputIterator, OutputIterator, Discontinuous, Sides, ScaledJacobian, Discontinuous>::prepEntry(
                entry, op, nullptr, values, source.Connectivity, source.Offset,
                shapeGradient, nullptr, shapeValues);
          }
        }
