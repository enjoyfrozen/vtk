  ...
  case PassType::GenerateConnectivity:
    {
      ...
      cellTypes->SetNumberOfTuples(totalCellCount);
      cellArray->ResizeExact(totalCellCount, totalConnCount);
    }
    break;
...
vtkDataArray* vtkCellGridToUnstructuredGrid::Query::GetOutputArray(
