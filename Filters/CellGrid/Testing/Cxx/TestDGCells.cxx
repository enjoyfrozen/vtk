...
template <> int numberOfSidesOfDimension<vtkDGEdge>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 2 : -1)); }

template <> int numberOfSidesOfDimension<vtkDGHex>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 8 : (dimension == 1 ? 12 : (dimension == 2 ? 6 : -1)))); }

template <> int numberOfSidesOfDimension<vtkDGPyr>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 5 : (dimension == 1 ? 8 : (dimension == 2 ? 5 : -1)))); }

template <> int numberOfSidesOfDimension<vtkDGQuad>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 4 : (dimension == 1 ? 4 : -1))); }

template <> int numberOfSidesOfDimension<vtkDGTet>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 4 : (dimension == 1 ? 6 : (dimension == 2 ? 4 : -1)))); }

template <> int numberOfSidesOfDimension<vtkDGTri>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 3 : (dimension == 1 ? 3 : -1))); }

template <> int numberOfSidesOfDimension<vtkDGVert>(int dimension)
{ return (dimension < 0 ? 1 : -1); }

template <> int numberOfSidesOfDimension<vtkDGWdg>(int dimension)
{ return (dimension < 0 ? 1 : (dimension == 0 ? 6 : (dimension == 1 ? 9 : (dimension == 2 ? 5 : -1)))); }
